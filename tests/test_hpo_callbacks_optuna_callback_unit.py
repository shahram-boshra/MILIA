...
class TestOptunaPruningCallbackInit:
    ...
    def test_init_success_with_default_parameters(self, mock_optuna, mock_trial):
        ...
        with patch.dict('sys.modules', {'optuna': mock_optuna}):
            with patch('milia_pipeline.models.hpo.callbacks.optuna_callback.OPTUNA_AVAILABLE', True):
                with patch('milia_pipeline.models.hpo.callbacks.optuna_callback.optuna', mock_optuna):
                    from milia_pipeline.models.hpo.callbacks.optuna_callback import OptunaPruningCallback
    ...
    def test_init_logs_debug_message(self, mock_optuna, mock_trial):
        ...
        with patch.dict('sys.modules', {'optuna': mock_optuna}):
            with patch('milia_pipeline.models.hpo.callbacks.optuna_callback.OPTUNA_AVAILABLE', True):
                with patch('milia_pipeline.models.hpo.callbacks.optuna_callback.optuna', mock_optuna):
                    with patch('milia_pipeline.models.hpo.callbacks.optuna_callback.logger') as mock_logger:
                        from milia_pipeline.models.hpo.callbacks.optuna_callback import OptunaPruningCallback
    ...
    def test_init_calls_super_init(self, mock_optuna, mock_trial):
        ...
        with patch.dict('sys.modules', {'optuna': mock_optuna}):
            with patch('milia_pipeline.models.hpo.callbacks.optuna_callback.OPTUNA_AVAILABLE', True):
                with patch('milia_pipeline.models.hpo.callbacks.optuna_callback.optuna', mock_optuna):
                    from milia_pipeline.models.hpo.callbacks.optuna_callback import OptunaPruningCallback, Callback
...
class TestOnEpochEnd:
    ...
    def test_on_epoch_end_reports_metric_to_trial(self, mock_optuna, mock_trial, mock_trainer, sample_metrics):
    ...
    def test_on_epoch_end_reports_every_epoch_by_default(self, mock_optuna, mock_trial, mock_trainer, sample_metrics):
    ...
    def test_on_epoch_end_respects_report_every_parameter(self, mock_optuna, mock_trial, mock_trainer, sample_metrics):
    ...
    def test_on_epoch_end_skips_intermediate_epochs(self, mock_optuna, mock_trial, mock_trainer, sample_metrics):
    ...
    def test_on_epoch_end_finds_metric_with_validation_prefix(self, mock_optuna, mock_trial, mock_trainer, sample_metrics_alternative_names):
    ...
    def test_on_epoch_end_removes_val_prefix_as_fallback(self, mock_optuna, mock_trial, mock_trainer):
    ...
    def test_on_epoch_end_logs_warning_when_metric_not_found(self, mock_optuna, mock_trial, mock_trainer, sample_metrics_missing_monitor):
    ...
    def test_on_epoch_end_returns_early_when_metric_not_found(self, mock_optuna, mock_trial, mock_trainer, sample_metrics_missing_monitor):
    ...
    def test_on_epoch_end_stores_last_reported_value(self, mock_optuna, mock_trial, mock_trainer, sample_metrics):
    ...
    def test_on_epoch_end_logs_debug_message(self, mock_optuna, mock_trial, mock_trainer, sample_metrics):
    ...
    def test_on_epoch_end_checks_for_pruning(self, mock_optuna, mock_trial, mock_trainer, sample_metrics):
    ...
    def test_on_epoch_end_raises_trial_pruned_when_should_prune(self, mock_optuna, mock_trial_pruned, mock_trainer, sample_metrics):
    ...
    def test_on_epoch_end_logs_info_when_pruned(self, mock_optuna, mock_trial_pruned, mock_trainer, sample_metrics):
    ...
    def test_on_epoch_end_does_not_raise_when_not_pruned(self, mock_optuna, mock_trial, mock_trainer, sample_metrics):
    ...
    def test_on_epoch_end_prevents_duplicate_step_reporting(self, mock_optuna, mock_trial, mock_trainer, sample_metrics):
    ...
    def test_on_epoch_end_tracks_reported_steps(self, mock_optuna, mock_trial, mock_trainer, sample_metrics):
    ...
    def test_on_epoch_end_logs_skip_message_for_duplicate_steps(self, mock_optuna, mock_trial, mock_trainer, sample_metrics):
            ...
            with patch('milia_pipeline.models.hpo.callbacks.optuna_callback.OPTUNA_AVAILABLE', True):
                with patch('milia_pipeline.models.hpo.callbacks.optuna_callback.optuna', mock_optuna):
                    with patch('milia_pipeline.models.hpo.callbacks.optuna_callback.logger') as mock_logger:
                        ...
                        debug_calls = [str(c) for c in mock_logger.debug.call_args_list]
                        assert any("already reported" in str(c).lower() or "skipping" in str(c).lower() for c in debug_calls)
    
    def test_on_epoch_end_still_checks_pruning_for_duplicate_steps(self, mock_optuna, mock_trial, mock_trainer, sample_metrics):
    ...
    def test_on_epoch_end_can_prune_on_duplicate_step(self, mock_optuna, mock_trainer, sample_metrics):
...
class TestOnTrainEnd:
    ...
    def test_on_train_end_uses_last_reported_value_as_fallback(self, mock_optuna, mock_trial, mock_trainer):
    ...
    def test_on_train_end_uses_metrics_history_when_available(self, mock_optuna, mock_trial, mock_trainer):
    ...
    def test_on_train_end_handles_trainer_without_metrics_history_attr(self, mock_optuna, mock_trial):
    ...
    def test_on_train_end_handles_empty_metric_history_list(self, mock_optuna, mock_trial, mock_trainer):
            ...
            with patch('milia_pipeline.models.hpo.callbacks.optuna_callback.OPTUNA_AVAILABLE', True):
                with patch('milia_pipeline.models.hpo.callbacks.optuna_callback.optuna', mock_optuna):
                    from milia_pipeline.models.hpo.callbacks.optuna_callback import (
                        create_hpo_callback, OptunaPruningCallback
                    )
        ...
        with patch.dict('sys.modules', {'optuna': mock_optuna}):
            with patch('milia_pipeline.models.hpo.callbacks.optuna_callback.OPTUNA_AVAILABLE', True):
                with patch('milia_pipeline.models.hpo.callbacks.optuna_callback.optuna', mock_optuna):
                    ...
                    callback = OptunaPruningCallback(trial=mock_trial, monitor="val_loss", report_every=1000)
                    metrics = {'val_loss': 0.5}
    ...
    def test_callback_inheritance_from_base_callback(self, mock_optuna, mock_trial):
        ...
        with patch.dict('sys.modules', {'optuna': mock_optuna}):
            with patch('milia_pipeline.models.hpo.callbacks.optuna_callback.OPTUNA_AVAILABLE', True):
                with patch('milia_pipeline.models.hpo.callbacks.optuna_callback.optuna', mock_optuna):
                    from milia_pipeline.models.hpo.callbacks.optuna_callback import (
                        OptunaPruningCallback, Callback
                    )
...
class TestExceptionHandling:
    ...
    def test_pruning_error_inherits_from_hpo_error(self):
        ...
        from milia_pipeline.exceptions import PruningError, HPOError
        assert issubclass(PruningError, HPOError)
    
    def test_trial_pruned_exception_message_format(self, mock_optuna, mock_trial_pruned, mock_trainer):
