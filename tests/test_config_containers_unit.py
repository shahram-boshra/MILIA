...
def sample_disabled_transform_spec():
    ...
    return TransformSpec(
        ...
        kwargs={},
        enabled=False,
        description='This transform is disabled'
    )
...
@pytest.fixture
def sample_experimental_setup_with_multiple_transforms(sample_transform_spec, sample_transform_spec_with_kwargs):
...
@pytest.fixture
def sample_transformation_config_with_standard(sample_experimental_setup, sample_standard_transforms):
...
class TestDatasetConfig:
    ...
    def test_post_init_uncertainty_auto_compute(self):
        ...
        config2 = DatasetConfig(
            dataset_type='DMC',
            uncertainty_config={'use_for_loss_weighting': False}
        )
...
class TestFilterConfig:
    ...
    def test_creation_with_values(self):
        ...
        config = FilterConfig(
            max_atoms=50,
            min_atoms=5,
            heavy_atom_filter={'max_heavy_atoms': 30}
        )
    ...
    def test_get_handler_filters_dft(self):
        ...
        config = FilterConfig(
            max_atoms=50,
            min_atoms=5,
            handler_filters={'DFT': {'custom_filter': True}}
        )
    ...
    def test_get_handler_filters_dmc(self):
        ...
        config = FilterConfig(
            max_atoms=50,
            dmc_uncertainty_filter={'threshold': 0.5}
        )
    ...
    def test_validate_filter_config_invalid_uncertainty_filter(self):
        ...
        config = FilterConfig(dmc_uncertainty_filter={})  # Empty dict is valid type but may fail validation
        is_valid, errors = config.validate_filter_config()
...
class TestStructuralFeaturesConfig:
    ...
    def test_validate_feature_config_non_string_atom_features(self):
        ...
        with pytest.raises(PydanticValidationError):
            StructuralFeaturesConfig(
                atom_features=['atomic_number', 123],
                bond_features=['bond_type']
            )
...
class TestProcessingConfig:
    ...
    def test_is_migration_enabled_true(self):
        ...
        config = ProcessingConfig(
            scalar_graph_targets=['Etot'],
            migration_settings={'enabled': True}
        )
...
class TestHandlerConfig:
    ...
    def test_validate_handler_config_invalid_recovery_mode(self):
        ...
        config = HandlerConfig(
            handler_type='DFT',
            error_handling={'recovery_mode': 'invalid_mode'}
        )
        is_valid, errors = config.validate_handler_config()
        assert is_valid is False
...
class TestExperimentalSetup:
    ...
    def test_get_transform_names(self, sample_transform_spec):
        ...
        setup = ExperimentalSetup(
            name='test',
            transforms=[sample_transform_spec, disabled_spec]
        )
...
class TestTransformationConfig:
    ...
    def test_creation_invalid_setup_type(self):
        ...
        with pytest.raises(PydanticValidationError):
            TransformationConfig(
                experimental_setups={'test': 'not_a_setup'},
                default_setup='test'
            )
    ...
    def test_get_enabled_setups(self, sample_experimental_setup, sample_transform_spec):
        ...
        config = TransformationConfig(
            experimental_setups={
                'baseline': sample_experimental_setup,
                'disabled': disabled_setup
            },
            default_setup='baseline'
        )
    ...
    def test_creation_with_standard_transforms(self, sample_experimental_setup, sample_standard_transforms):
    ...
    def test_get_standard_transforms_as_dicts(self, sample_experimental_setup, sample_standard_transforms):
    ...
    def test_get_combined_transforms_uses_default_setup(self, sample_experimental_setup, sample_standard_transforms):
    ...
    def test_get_combined_transforms_nonexistent_setup(self, sample_experimental_setup, sample_standard_transforms):
    ...
    def test_get_combined_transforms_as_dicts(self, sample_experimental_setup, sample_standard_transforms):
    ...
    def test_has_standard_transforms_true(self, sample_experimental_setup, sample_standard_transforms):
...
class TestUtilityFunctions:
    ...
    def test_get_config_summary(self, sample_transformation_config):
        ...
        bundle = {
            'transformation_config': sample_transformation_config
        }
...
class TestEdgeCases:
    ...
    def test_transformation_config_single_setup(self, sample_experimental_setup):
        ...
        config = TransformationConfig(
            experimental_setups={'single': sample_experimental_setup},
...
class TestDescriptorConfig:
    ...
    def test_get_category_descriptors(self):
        ...
        config = DescriptorConfig(
            categories={
                'constitutional': {'descriptors': ['MW', 'LogP']}
            }
        )
    ...
    def test_get_category_options(self):
        ...
        config = DescriptorConfig(
            categories={
                'constitutional': {'options': {'precision': 'high'}}
            }
        )
...
class TestCreateHandlerConfigFactory:
    ...
    def test_create_handler_config_dmc(self):
        ...
        assert 'validate_uncertainty' in config.validation_settings or config.migration_mode is False
...
class TestValidateHandlerConfigurationBundle:
    ...
    def test_validate_complete_valid_bundle(self):
        ...
        trans_config = TransformationConfig(
            experimental_setups={'baseline': setup},
            default_setup='baseline'
        )
...
class TestTransformationConfigValidation:
    ...
    def test_validate_transformation_config_multiple_setups(self, sample_transform_spec):
        ...
        setup2 = ExperimentalSetup(
            name='setup2',
            transforms=[TransformSpec(name='Transform2')]
        )
    ...
    def test_validate_transformation_config_with_validation_settings(self, sample_experimental_setup):
...
class TestStructuralFeaturesConfigExtended:
    ...
    def test_get_handler_features_with_override(self):
        ...
        config = StructuralFeaturesConfig(
            ...
            handler_features={
                'DMC': {
                    'atom_features': ['atomic_number', 'spin']
                }
            }
        )
        features = config.get_handler_features('DMC')
...
class TestHandlerConfigExtended:
    ...
    def test_get_error_recovery_mode(self):
        ...
        config = HandlerConfig(
            handler_type='DFT',
            error_handling={'recovery_mode': 'raise_error'}
        )
...
class TestCheckConfigurationCompatibilityExtended:
    ...
    def test_compatibility_different_handler_types(self):
        ...
        config_b = {
            'handler_config': HandlerConfig(handler_type='DMC')
        }
