...
def mock_train_loader(mock_pyg_batch):
    ...
    loader.__iter__ = Mock(side_effect=lambda: iter([mock_pyg_batch, mock_pyg_batch, mock_pyg_batch]))
...
class TestTrainerInitialization:
    ...
    def test_trainer_initialization_full(
        self, mock_model, mock_train_loader, mock_val_loader, 
        mock_test_loader, mock_optimizer, mock_scheduler, 
        mock_loss_fn, mock_callback, mock_hpo_callback, temp_checkpoint_dir
    ):
    ...
    def test_trainer_auto_device_detection_cuda(self, mock_model, mock_train_loader, mock_optimizer):
...
class TestHPOCallback:
    ...
    def test_hpo_callback_none_by_default(
    ...
    def test_hpo_callback_appended_with_existing_callbacks(
        self, mock_model, mock_train_loader, mock_optimizer, 
        mock_callback, mock_hpo_callback
    ):
    ...
    def test_hpo_callback_receives_on_train_begin(
        self, mock_model, mock_train_loader, mock_optimizer, 
        mock_hpo_callback, mock_loss_fn
    ):
    ...
    def test_hpo_callback_with_validation(
        self, mock_model, mock_train_loader, mock_val_loader, 
        mock_optimizer, mock_hpo_callback, mock_loss_fn
    ):
    ...
    def test_hpo_callback_logging(
        self, mock_model, mock_train_loader, mock_optimizer, 
        mock_hpo_callback, mock_loss_fn, caplog
    ):
...
class TestForwardPass:
    ...
    def test_forward_pass_with_edge_attr_and_model_info(
        self, mock_model, mock_train_loader, mock_optimizer, mock_pyg_batch, mock_model_info_with_edge
    ):
    ...
    def test_forward_pass_node_level_task(
        self, mock_model, mock_train_loader, mock_optimizer
    ):
...
class TestScheduler:
    ...
    def test_reduce_lr_on_plateau_scheduler(
        self, mock_model, mock_train_loader, mock_val_loader, 
        mock_optimizer, mock_reduce_lr_scheduler, mock_loss_fn
    ):
    ...
    def test_scheduler_without_validation(
        self, mock_model, mock_train_loader, mock_optimizer, 
        mock_reduce_lr_scheduler, mock_loss_fn
    ):
...
class TestCheckpoint:
    ...
    def test_save_checkpoint_basic(
        self, mock_model, mock_train_loader, mock_optimizer, 
        mock_loss_fn, temp_checkpoint_dir
    ):
    ...
    def test_save_checkpoint_with_scheduler(
        self, mock_model, mock_train_loader, mock_optimizer, 
        mock_scheduler, mock_loss_fn, temp_checkpoint_dir
    ):
...
class TestLogging:
    ...
    def test_epoch_summary_logging(
        self, mock_model, mock_train_loader, mock_val_loader, 
        mock_optimizer, mock_loss_fn, caplog
    ):
...
class TestEdgeCases:
    ...
    def test_trainer_with_nan_loss(
        self, mock_model, mock_train_loader, mock_optimizer
    ):
...
class TestIntegration:
    ...
    def test_real_model_training(self):
        ...
        def create_batch():
            ...
            batch.batch = torch.cat([torch.zeros(10, dtype=torch.long), 
...
class TestBatchProcessingEdgeCases:
    ...
    def test_varying_batch_sizes(self, mock_model, mock_optimizer, mock_loss_fn):
        ...
        batch2.batch = torch.cat([torch.zeros(15, dtype=torch.long), torch.ones(15, dtype=torch.long)])
...
class TestCheckpointCorruptionAndEdgeCases:
    ...
    def test_checkpoint_preserves_all_state(
        self, mock_model, mock_train_loader, mock_val_loader, 
        mock_optimizer, mock_scheduler, mock_loss_fn, temp_checkpoint_dir
    ):
...
class TestLoggingAndMonitoring:
    ...
    def test_log_every_n_steps_zero(
        ...
        with caplog.at_level(logging.DEBUG):
            ...
            with pytest.raises(TrainingError, match="Training batch failed|integer division or modulo by zero"):
                trainer.fit()
...
class TestMetricsAndResultsValidation:
    ...
    def test_results_structure_completeness(
        self, mock_model, mock_train_loader, mock_val_loader, 
        mock_test_loader, mock_optimizer, mock_loss_fn
    ):
...
class TestIntegrationExtended:
    ...
    def test_full_training_pipeline_with_all_features(
        self, mock_model, mock_train_loader, mock_val_loader, mock_test_loader,
        mock_optimizer, mock_scheduler, mock_callback, mock_loss_fn, temp_checkpoint_dir
    ):
...
class TestMetricsParameter:
    ...
    def test_metrics_default_empty_dict(
        self, mock_model, mock_train_loader, mock_optimizer
    ):
    ...
    def test_validate_epoch_computes_metrics(
        self, mock_model, mock_train_loader, mock_val_loader, 
        mock_optimizer, mock_loss_fn, mock_metric
    ):
...
class TestTaskTypeHandling:
    ...
    def test_is_classification_stored_from_model_info(
        self, mock_model, mock_train_loader, mock_optimizer,
        mock_model_info_graph_classification
    ):
    ...
    def test_is_graph_level_task_none(
        self, mock_model, mock_train_loader, mock_optimizer
    ):
...
class TestTargetHandling:
    ...
    def test_get_target_link_prediction(
        self, mock_model, mock_train_loader, mock_optimizer,
        mock_model_info_link_prediction, mock_pyg_batch_link_prediction
    ):
    ...
    def test_get_target_edge_regression_with_edge_value(
        self, mock_model, mock_train_loader, mock_optimizer,
        mock_model_info_edge_regression, mock_pyg_batch_edge_regression
    ):
    ...
    def test_get_target_graph_regression(
        self, mock_model, mock_train_loader, mock_optimizer,
        mock_model_info_graph_regression, mock_pyg_batch
    ):
...
class TestTargetSelection:
    ...
    def test_target_selection_stored_from_model_info(
        self, mock_model, mock_train_loader, mock_optimizer,
        mock_model_info_with_target_selection
    ):
...
class TestDynamicForwardSignature:
    ...
    def test_get_forward_signature_params_basic(
    ...
    def test_get_forward_signature_params_3d_model(
        self, mock_train_loader, mock_optimizer
    ):
...
class TestModel3DParams:
    ...
    def test_model_accepts_3d_params_true(
        self, mock_train_loader, mock_optimizer
    ):
    ...
    def test_model_accepts_3d_params_false(
        self, mock_train_loader, mock_optimizer
    ):
...
class TestCheckpointV2Format:
    ...
    def test_is_v2_checkpoint_returns_false_for_invalid(
...
class TestJsonSerialization:
    ...
    def test_serialize_torch_scalar_tensor(
        self, mock_model, mock_train_loader, mock_optimizer
    ):
...
class TestPrepareTargetForMetrics:
    ...
    def test_prepare_target_none_returns_none(
        self, mock_model, mock_train_loader, mock_optimizer
    ):
...
class TestTaskTypeEdgeCases:
    ...
    def test_is_edge_level_task_none(
        self, mock_model, mock_train_loader, mock_optimizer
    ):
...
class TestGraphLevelMultiTargetReshape:
    ...
    def test_get_target_2d_no_reshape_needed(
        self, mock_model, mock_train_loader, mock_optimizer
    ):
...
class TestDynamicForwardSignatureAdvanced:
    ...
    def test_forward_signature_params_cached(
        self, mock_train_loader, mock_optimizer
    ):
    ...
    def test_forward_signature_wrapped_model(
        self, mock_train_loader, mock_optimizer
    ):
...
class TestEnsembleAndComposition3DDetection:
    ...
    def test_model_accepts_3d_params_ensemble_outer(
        self, mock_train_loader, mock_optimizer
    ):
    ...
    def test_model_accepts_3d_params_ensemble_inner(
        self, mock_train_loader, mock_optimizer
    ):
    ...
    def test_model_accepts_3d_params_composition(
        self, mock_train_loader, mock_optimizer
    ):
    ...
    def test_model_accepts_3d_params_stack(
        self, mock_train_loader, mock_optimizer
    ):
    ...
    def test_model_accepts_3d_params_caching(
        self, mock_train_loader, mock_optimizer
    ):
...
class TestSaveResultsAdvanced:
    ...
    def test_save_results_metadata_in_json(
        ...
        with open(saved_paths['results_path'], 'r') as f:
            data = json.load(f)
...
class TestJsonSerializationAdvanced:
    ...
    def test_serialize_torch_array(
        self, mock_model, mock_train_loader, mock_optimizer
    ):
    ...
    def test_serialize_unknown_type_to_string(
        self, mock_model, mock_train_loader, mock_optimizer
    ):
...
class TestTestMethodWithMetrics:
    ...
    def test_test_with_metrics_computed(
        self, mock_model, mock_train_loader, mock_test_loader,
        mock_optimizer, mock_loss_fn, mock_metric
    ):
