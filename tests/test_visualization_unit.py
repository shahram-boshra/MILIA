...
class TestDependencyAvailability:
    ...
    def test_initialization_warns_when_matplotlib_unavailable(self, basic_metrics_history, caplog):
        """Test that warning is logged when matplotlib is unavailable."""
        with patch("milia_pipeline.models.training.visualization.MATPLOTLIB_AVAILABLE", False):
            from milia_pipeline.models.training.visualization import TrainingVisualizer
    ...
    def test_initialization_warns_when_plotly_unavailable(self, basic_metrics_history, caplog):
        """Test that warning is logged when plotly is unavailable."""
        with patch("milia_pipeline.models.training.visualization.PLOTLY_AVAILABLE", False):
            from milia_pipeline.models.training.visualization import TrainingVisualizer
...
class TestPlotLossCurves:
    ...
    def test_plot_loss_curves_with_save_path(self, basic_metrics_history, temp_output_dir):
    ...
    def test_plot_loss_curves_with_path_object(self, basic_metrics_history, temp_output_dir):
    ...
    def test_plot_loss_curves_with_string_path(self, basic_metrics_history, temp_output_dir):
    ...
    def test_plot_loss_curves_returns_none_without_matplotlib(self, basic_metrics_history):
...
class TestPlotMetrics:
    ...
    def test_plot_metrics_with_save_path(self, comprehensive_metrics_history, temp_output_dir):
    ...
    def test_plot_metrics_returns_none_without_matplotlib(self, comprehensive_metrics_history):
...
class TestPlotLearningRate:
    ...
    def test_plot_learning_rate_with_uppercase_key(self, metrics_history_with_lr_uppercase):
        """Test learning rate plotting with 'LR' key."""
        from milia_pipeline.models.training.visualization import (
            MATPLOTLIB_AVAILABLE,
            TrainingVisualizer,
    ...
    def test_plot_learning_rate_custom_title(self, metrics_history_with_learning_rate):
...
class TestPlotInteractive:
    ...
    def test_plot_interactive_save_html(self, basic_metrics_history, temp_output_dir):
    ...
    def test_plot_interactive_save_png_with_kaleido(self, basic_metrics_history, temp_output_dir):
    ...
    def test_plot_interactive_save_pdf_with_kaleido(self, basic_metrics_history, temp_output_dir):
    ...
    def test_plot_interactive_returns_none_without_plotly(self, basic_metrics_history):
...
class TestPlotTrainingSummary:
    ...
    def test_plot_training_summary_png_only(self, comprehensive_metrics_history, temp_output_dir):
        ...
        visualizer = TrainingVisualizer(comprehensive_metrics_history)
        saved_paths = visualizer.plot_training_summary(output_dir=temp_output_dir, formats=["png"])

        assert isinstance(saved_paths, dict)
        # Should not have html
        assert "interactive_html" not in saved_paths

    def test_plot_training_summary_html_only(self, comprehensive_metrics_history, temp_output_dir):
        ...
        visualizer = TrainingVisualizer(comprehensive_metrics_history)
        saved_paths = visualizer.plot_training_summary(output_dir=temp_output_dir, formats=["html"])
    ...
    def test_plot_training_summary_with_prefix(
        ...
        saved_paths = visualizer.plot_training_summary(
            output_dir=temp_output_dir, prefix="experiment1"
        )
    ...
    def test_plot_training_summary_with_pdf_format(
        ...
        with patch("plotly.graph_objects.Figure.write_image") as mock_write_image:
            saved_paths = visualizer.plot_training_summary(
                output_dir=temp_output_dir, formats=["pdf"]
            )
            assert isinstance(saved_paths, dict)
    ...
    def test_plot_training_summary_all_formats(
        ...
        try:
            saved_paths = visualizer.plot_training_summary(
                output_dir=temp_output_dir, formats=["png", "html", "pdf"]
            )
            assert isinstance(saved_paths, dict)
            ...
            if "Chrome" in str(e) or "chrome" in str(e):
                ...
                saved_paths = visualizer.plot_training_summary(
                    output_dir=temp_output_dir, formats=["png", "html"]
                )
                assert isinstance(saved_paths, dict)
            else:
                raise

    def test_plot_training_summary_empty_metrics(self, empty_metrics_history, temp_output_dir):
    ...
    def test_plot_training_summary_string_output_dir(
        ...
        visualizer = TrainingVisualizer(comprehensive_metrics_history)
        saved_paths = visualizer.plot_training_summary(output_dir=str(temp_output_dir))
...
class TestConvenienceFunctions:
    ...
    def test_plot_training_summary_function(self, comprehensive_metrics_history, temp_output_dir):
        """Test plot_training_summary convenience function."""
        from milia_pipeline.models.training.visualization import plot_training_summary

        saved_paths = plot_training_summary(
            metrics_history=comprehensive_metrics_history, output_dir=temp_output_dir
        )
    ...
    def test_create_visualizer_function_with_style(self, basic_metrics_history, custom_style):
    ...
    def test_create_visualizer_function_with_none_style(self, basic_metrics_history):
...
class TestIntegration:
    ...
    def test_summary_then_individual_plots(self, comprehensive_metrics_history, temp_output_dir):
        ...
        summary_paths = visualizer.plot_training_summary(output_dir=temp_output_dir / "summary")
...
class TestConcurrency:
    ...
    def test_multiple_figures_sequential(self, basic_metrics_history, temp_output_dir):
        ...
        figs = []
        for i in range(5):
            fig = visualizer.plot_loss_curves(save_path=temp_output_dir / f"loss_{i}.png")
            figs.append(fig)
