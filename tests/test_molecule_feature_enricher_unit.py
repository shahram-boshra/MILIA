...
class MockDFTHandler(MockDatasetHandler):
    ...
    def __init__(self, capabilities=None):
        default_caps = {
            ...
            'dft_specific': {
                'vibrational_validation': True,
                'electronic_validation': True
            }
        }
        if capabilities:
...
class MockDMCHandler(MockDatasetHandler):
    ...
    def __init__(self, uncertainty_enabled=False, capabilities=None):
        default_caps = {
            ...
            'dmc_specific': {
                'uncertainty_validation': True,
                'statistical_quality_check': True
            }
        }
        if capabilities:
            default_caps.update(capabilities)
...
class MockWavefunctionHandler(MockDatasetHandler):
    ...
    def __init__(self, capabilities=None):
        default_caps = {
            ...
            'wavefunction_specific': {
                'mo_validation': True,
                'homo_lumo_analysis': True
            }
        }
        if capabilities:
            default_caps.update(capabilities)
...
class TestFeatureValidation(unittest.TestCase):
    ...
    def test_validation_quality_checks(self):
        ...
        handler = MockDFTHandler()
        handler.validate_feature_quality = Mock(return_value={
            'passed': False,
            'issues': ['test_issue']
        })
    ...
    def test_statistical_validation(self):
        ...
        handler = MockDFTHandler(capabilities={
...
class TestErrorHandling(unittest.TestCase):
    ...
    def test_handler_operation_error_propagation(self):
        ...
        handler = MockDFTHandler()
        handler.get_dataset_type = Mock(side_effect=HandlerOperationError(
            message="Test error",
            handler_type="DFT",
            operation="test"
        ))
...
class TestEdgeCases(unittest.TestCase):
    ...
    def test_extreme_coordinates(self):
        ...
        pyg_data = create_sample_pyg_data()
        pyg_data.pos = torch.tensor([[1e10, 1e10, 1e10],
                                      [1e-10, 1e-10, 1e-10],
                                      [0.0, 0.0, 0.0]])
...
class TestDatasetSpecificBehaviors(unittest.TestCase):
    ...
    def test_dft_capability_specific_validation(self):
        ...
        dft_handler = MockDFTHandler(capabilities={
            'dft_specific': {
                'vibrational_validation': True,
                'electronic_validation': True
            }
    ...
    def test_dmc_capability_specific_validation(self):
        ...
        dmc_handler = MockDMCHandler(uncertainty_enabled=True, capabilities={
            'dmc_specific': {
                'uncertainty_validation': True,
                'statistical_quality_check': True
            }
...
class TestHandlerEdgeCases(unittest.TestCase):
    ...
    def test_validate_feature_quality_raises_handler_error(self):
        ...
        handler.validate_feature_quality = Mock(
            side_effect=HandlerError("validation failed")
        )
