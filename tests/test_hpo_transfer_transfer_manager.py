...
class MockTransferredTrial:
    ...
    source_study: Optional[str] = None
...
class MockHPOError(Exception):
    ...
    def __init__(self, message: str, study_name: Optional[str] = None, details: Optional[str] = None, **kwargs):
...
class TestMetaFeatureMethodEnum:
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_warm_start', return_value=(None, None, None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_hpo_error', return_value=None)
...
class TestTransferConfig:
    ...
    def test_transfer_config_default_values(self, *mocks):
        ...
        from milia_pipeline.models.hpo.transfer.transfer_manager import TransferConfig, MetaFeatureMethod, AdaptationMethod
    ...
    def test_transfer_config_converts_string_meta_feature_method(self, *mocks):
        ...
        from milia_pipeline.models.hpo.transfer.transfer_manager import TransferConfig, MetaFeatureMethod
    ...
    def test_transfer_config_converts_string_adaptation_method(self, *mocks):
        ...
        from milia_pipeline.models.hpo.transfer.transfer_manager import TransferConfig, AdaptationMethod
...
class TestHPOTransferManagerInit:
    ...
    def test_init_with_default_config(self, *mocks):
        ...
        from milia_pipeline.models.hpo.transfer.transfer_manager import HPOTransferManager, TransferConfig
    ...
    def test_init_lazy_loads_optuna(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_init_lazy_loads_meta_features(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_init_lazy_loads_warm_start(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
        """Test initialization lazy-loads warm_start module."""
        from milia_pipeline.models.hpo.transfer.transfer_manager import HPOTransferManager
        
        mock_warm_start.return_value = (MockWarmStartStrategy, MockWarmStartConfig, MockWarmStartMethod, MockTransferredTrial)
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_init_lazy_loads_hpo_error(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_init_handles_none_optuna(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_init_with_persist_meta_db_loads_from_disk(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error, mock_exists):
        """Test initialization with persist_meta_db attempts to load from disk."""
        from milia_pipeline.models.hpo.transfer.transfer_manager import HPOTransferManager, TransferConfig
        
        config = TransferConfig(
            persist_meta_db=True,
            meta_db_path="/path/to/meta_db.json"
        )
        manager = HPOTransferManager(config)
...
class TestHPOTransferManagerRegistration:
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna')
    def test_register_study_success(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna')
    def test_register_study_caches_study(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna')
    def test_register_study_no_cache(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna')
    def test_register_study_raises_for_duplicate(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna')
    def test_register_study_extracts_study_info(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna')
    def test_unregister_study_success(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_unregister_study_not_found(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna')
    def test_unregister_study_clears_cache(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna')
    def test_unregister_study_saves_meta_db_when_persist_enabled(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna')
    def test_get_registered_studies(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_get_registered_studies_empty(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna')
    def test_get_study_info_success(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
        """Test get_study_info returns study info for registered study."""
        from milia_pipeline.models.hpo.transfer.transfer_manager import HPOTransferManager, RegisteredStudyInfo
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_get_study_info_not_found(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna')
    def test_register_study_with_dataset_info(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
...
class TestFindSimilarStudies:
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna')
    def test_find_similar_studies_empty_registry(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna')
    def test_find_similar_studies_returns_sorted_by_similarity(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
        ...
        study = MockStudy()
        manager.register_study(study_name="study1", study=study, dataset=mock_dataset, meta_features={"n_samples": 1000.0, "mean_nodes": 25.0})
        manager.register_study(study_name="study2", study=study, dataset=mock_dataset, meta_features={"n_samples": 500.0, "mean_nodes": 20.0})
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna')
    def test_find_similar_studies_respects_top_k(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
        ...
        study = MockStudy()
        for i in range(5):
            manager.register_study(study_name=f"study{i}", study=study, dataset=mock_dataset, meta_features={"n_samples": float(1000 + i * 100), "mean_nodes": 25.0})
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna')
    def test_find_similar_studies_filters_by_model_name(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
        ...
        study = MockStudy()
        manager.register_study(study_name="gcn_study", study=study, dataset=mock_dataset, meta_features={"n_samples": 1000.0}, model_name="GCN")
        manager.register_study(study_name="gat_study", study=study, dataset=mock_dataset, meta_features={"n_samples": 1000.0}, model_name="GAT")
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna')
    def test_find_similar_studies_filters_by_min_trials(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
        ...
        manager.register_study(study_name="many_trials", study=study1, dataset=mock_dataset, meta_features={"n_samples": 1000.0})
        manager.register_study(study_name="few_trials", study=study2, dataset=mock_dataset, meta_features={"n_samples": 1000.0})
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna')
    def test_find_similar_studies_respects_similarity_threshold(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
        ...
        study = MockStudy()
        manager.register_study(study_name="study1", study=study, dataset=mock_dataset, meta_features={"n_samples": 100.0})
...
class TestComputeDatasetSimilarity:
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_compute_dataset_similarity_same_dataset(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_compute_dataset_similarity_different_datasets(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
...
class TestComputeSimilarity:
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_compute_similarity_identical_features(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_compute_similarity_no_common_keys(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_compute_similarity_partial_overlap(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_compute_similarity_zero_vectors(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features')
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_compute_similarity_uses_meta_extractor_if_available(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_compute_similarity_clamps_to_valid_range(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
...
class TestComputeDatasetSimilarity:
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_compute_dataset_similarity_identical_datasets(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features')
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_compute_dataset_similarity_uses_meta_extractor(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
...
class TestExtractMetaFeatures:
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_extract_meta_features_fallback_to_basic(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features')
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_extract_meta_features_uses_extractor_when_available(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
...
class TestWarmStartStudy:
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna')
    def test_warm_start_study_raises_without_source_or_dataset(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna')
    def test_warm_start_study_returns_zero_for_empty_sources(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna')
    def test_warm_start_study_warns_for_missing_source(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna')
    def test_warm_start_study_transfers_trials(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna')
    def test_warm_start_study_auto_detects_similar_studies(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
...
class TestTransferTrials:
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_transfer_trials_returns_zero_without_optuna(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
        ...
        target_study = MockStudy()
        result = manager._transfer_trials(source_study=source_study, target_study=target_study, n_trials=5)
        assert result == 0
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna')
    def test_transfer_trials_enqueues_trials(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna')
    def test_transfer_trials_respects_n_trials(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
        ...
        source_study = MockStudy(trials=[MockTrial({"lr": 0.001 * i}, 0.1 * i) for i in range(1, 11)])
        target_study = MockStudy()
        result = manager._transfer_trials(source_study=source_study, target_study=target_study, n_trials=3)
        assert result <= 3
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna')
    def test_transfer_trials_filters_by_search_space(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
        ...
        target_study = MockStudy()
        result = manager._transfer_trials(source_study=source_study, target_study=target_study, n_trials=5, target_search_space=sample_search_space)
        assert result >= 0
...
class TestFilterParams:
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_filter_params_keeps_valid_params(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_filter_params_removes_unknown_params(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_filter_params_scales_int_to_bounds(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_filter_params_scales_float_to_bounds(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_filter_params_handles_categorical(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_filter_params_uses_warm_start_if_available(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
...
class TestFlattenSearchSpace:
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_flatten_search_space_nested(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_flatten_search_space_already_flat(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_flatten_search_space_empty(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
...
class TestAddNoiseToParams:
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_add_noise_returns_params_when_no_search_space(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_add_noise_modifies_float_params(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_add_noise_respects_bounds(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_add_noise_modifies_int_params(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
...
class TestExtractMetaFeatures:
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features')
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_extract_meta_features_uses_extractor_if_available(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_extract_meta_features_falls_back_to_basic(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
...
class TestBasicMetaFeatures:
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_basic_meta_features_extracts_n_samples(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_basic_meta_features_extracts_n_features(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_basic_meta_features_handles_empty_dataset(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_basic_meta_features_handles_exception(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_basic_meta_features_extracts_edge_stats(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_basic_meta_features_extracts_target_stats(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_basic_meta_features_handles_multi_target(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_meta_features', return_value=(None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_optuna', return_value=None)
    def test_basic_meta_features_handles_no_x_attribute(self, mock_optuna, mock_meta_features, mock_warm_start, mock_hpo_error):
...
class TestSaveMetaDb:
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_warm_start', return_value=(None, None, None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_hpo_error', return_value=None)
    def test_save_meta_db_does_nothing_without_path(self, mock_hpo_error, mock_warm_start, mock_meta_features, mock_optuna):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_warm_start', return_value=(None, None, None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_hpo_error', return_value=None)
    def test_save_meta_db_writes_to_file(self, mock_hpo_error, mock_warm_start, mock_meta_features, mock_optuna, temp_meta_db_path, mock_dataset):
        ...
        with open(temp_meta_db_path, 'r') as f:
            data = json.load(f)
    ...
    def test_save_meta_db_handles_write_error(self, mock_open, mock_hpo_error, mock_warm_start, mock_meta_features, mock_optuna):
...
class TestLoadMetaDb:
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_warm_start', return_value=(None, None, None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_hpo_error', return_value=None)
    def test_load_meta_db_does_nothing_without_path(self, mock_hpo_error, mock_warm_start, mock_meta_features, mock_optuna):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_hpo_error', return_value=None)
    @patch('os.path.exists', return_value=False)
    def test_load_meta_db_does_nothing_when_file_not_exists(self, mock_exists, mock_hpo_error, mock_warm_start, mock_meta_features, mock_optuna):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_warm_start', return_value=(None, None, None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_hpo_error', return_value=None)
    def test_load_meta_db_loads_data(self, mock_hpo_error, mock_warm_start, mock_meta_features, mock_optuna, temp_meta_db_path, sample_study_info_data):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_warm_start', return_value=(None, None, None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_hpo_error', return_value=None)
    def test_load_meta_db_handles_invalid_json(self, mock_hpo_error, mock_warm_start, mock_meta_features, mock_optuna, temp_meta_db_path):
...
class TestExportMetaDb:
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_warm_start', return_value=(None, None, None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_hpo_error', return_value=None)
    def test_export_meta_db_writes_to_file(self, mock_hpo_error, mock_warm_start, mock_meta_features, mock_optuna, temp_meta_db_path, mock_dataset):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_warm_start', return_value=(None, None, None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_hpo_error', return_value=None)
    def test_export_meta_db_empty_db(self, mock_hpo_error, mock_warm_start, mock_meta_features, mock_optuna, temp_meta_db_path):
...
class TestImportMetaDb:
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_warm_start', return_value=(None, None, None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_hpo_error', return_value=None)
    def test_import_meta_db_loads_data(self, mock_hpo_error, mock_warm_start, mock_meta_features, mock_optuna, temp_meta_db_path, sample_study_info_data):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_warm_start', return_value=(None, None, None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_hpo_error', return_value=None)
    def test_import_meta_db_merge_true(self, mock_hpo_error, mock_warm_start, mock_meta_features, mock_optuna, temp_meta_db_path, sample_study_info_data, mock_dataset):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_warm_start', return_value=(None, None, None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_hpo_error', return_value=None)
    def test_import_meta_db_merge_false(self, mock_hpo_error, mock_warm_start, mock_meta_features, mock_optuna, temp_meta_db_path, sample_study_info_data, mock_dataset):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_warm_start', return_value=(None, None, None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_hpo_error', return_value=None)
    def test_import_meta_db_skips_duplicates(self, mock_hpo_error, mock_warm_start, mock_meta_features, mock_optuna, temp_meta_db_path, sample_study_info_data):
...
class TestGetTransferSummary:
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_warm_start', return_value=(None, None, None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_hpo_error', return_value=None)
    def test_get_transfer_summary_empty(self, mock_hpo_error, mock_warm_start, mock_meta_features, mock_optuna):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_warm_start', return_value=(None, None, None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_hpo_error', return_value=None)
    def test_get_transfer_summary_with_studies(self, mock_hpo_error, mock_warm_start, mock_meta_features, mock_optuna, mock_dataset):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_warm_start', return_value=(None, None, None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_hpo_error', return_value=None)
    def test_get_transfer_summary_includes_config_info(self, mock_hpo_error, mock_warm_start, mock_meta_features, mock_optuna, mock_dataset):
...
class TestClear:
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_warm_start', return_value=(None, None, None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_hpo_error', return_value=None)
    def test_clear_removes_all_studies(self, mock_hpo_error, mock_warm_start, mock_meta_features, mock_optuna, mock_dataset):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_warm_start', return_value=(None, None, None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_hpo_error', return_value=None)
    def test_clear_removes_cache(self, mock_hpo_error, mock_warm_start, mock_meta_features, mock_optuna, mock_dataset):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_warm_start', return_value=(None, None, None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_hpo_error', return_value=None)
    def test_clear_on_empty_manager(self, mock_hpo_error, mock_warm_start, mock_meta_features, mock_optuna):
...
class TestRaiseHpoError:
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_warm_start', return_value=(None, None, None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_hpo_error')
    def test_raise_hpo_error_uses_hpo_error_if_available(self, mock_hpo_error, mock_warm_start, mock_meta_features, mock_optuna):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_warm_start', return_value=(None, None, None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_hpo_error', return_value=None)
    def test_raise_hpo_error_falls_back_to_runtime_error(self, mock_hpo_error, mock_warm_start, mock_meta_features, mock_optuna):
...
class TestRepr:
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_warm_start', return_value=(None, None, None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_hpo_error', return_value=None)
    def test_repr_empty_manager(self, mock_hpo_error, mock_warm_start, mock_meta_features, mock_optuna):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_warm_start', return_value=(None, None, None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_hpo_error', return_value=None)
    def test_repr_with_studies(self, mock_hpo_error, mock_warm_start, mock_meta_features, mock_optuna, mock_dataset):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_warm_start', return_value=(None, None, None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_hpo_error', return_value=None)
    def test_repr_includes_similarity_threshold(self, mock_hpo_error, mock_warm_start, mock_meta_features, mock_optuna):
...
class TestIntegrationScenarios:
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_warm_start', return_value=(None, None, None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_hpo_error', return_value=None)
    def test_full_workflow_register_find_warmstart(self, mock_hpo_error, mock_warm_start, mock_meta_features, mock_optuna, mock_dataset):
        ...
        source_study = MockStudy(
            trials=[MockTrial({"lr": 0.001, "hidden_dim": 128}, 0.1)]
        )
        manager.register_study(
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_warm_start', return_value=(None, None, None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_hpo_error', return_value=None)
    def test_export_import_roundtrip(self, mock_hpo_error, mock_warm_start, mock_meta_features, mock_optuna, temp_meta_db_path, mock_dataset):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_warm_start', return_value=(None, None, None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_hpo_error', return_value=None)
    def test_multiple_model_types(self, mock_hpo_error, mock_warm_start, mock_meta_features, mock_optuna, mock_dataset):
...
class TestEdgeCasesAndErrorHandling:
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_warm_start', return_value=(None, None, None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_hpo_error', return_value=None)
    def test_register_study_with_no_trials(self, mock_hpo_error, mock_warm_start, mock_meta_features, mock_optuna, mock_dataset):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_warm_start', return_value=(None, None, None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_hpo_error', return_value=None)
    def test_register_study_with_direction_name_attribute(self, mock_hpo_error, mock_warm_start, mock_meta_features, mock_optuna, mock_dataset):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_warm_start', return_value=(None, None, None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_hpo_error', return_value=None)
    def test_warm_start_with_enqueue_error(self, mock_hpo_error, mock_warm_start, mock_meta_features, mock_optuna, mock_dataset):
        ...
        result = manager.warm_start_study(
            target_study,
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_warm_start', return_value=(None, None, None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_hpo_error', return_value=None)
    def test_filter_params_with_enum_type(self, mock_hpo_error, mock_warm_start, mock_meta_features, mock_optuna):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_warm_start', return_value=(None, None, None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_hpo_error', return_value=None)
    def test_filter_params_int_uniform_type(self, mock_hpo_error, mock_warm_start, mock_meta_features, mock_optuna):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_warm_start', return_value=(None, None, None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_hpo_error', return_value=None)
    def test_filter_params_uniform_type(self, mock_hpo_error, mock_warm_start, mock_meta_features, mock_optuna):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_warm_start', return_value=(None, None, None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_hpo_error', return_value=None)
    def test_filter_params_unknown_type(self, mock_hpo_error, mock_warm_start, mock_meta_features, mock_optuna):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_warm_start', return_value=(None, None, None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_hpo_error', return_value=None)
    def test_basic_meta_features_dataset_without_target(self, mock_hpo_error, mock_warm_start, mock_meta_features, mock_optuna):
...
class TestModuleExports:
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_warm_start', return_value=(None, None, None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_hpo_error', return_value=None)
    def test_all_exports_available(self, mock_hpo_error, mock_warm_start, mock_meta_features, mock_optuna):
    ...
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_warm_start', return_value=(None, None, None, None))
    @patch('milia_pipeline.models.hpo.transfer.transfer_manager._lazy_import_hpo_error', return_value=None)
    def test_all_list_matches_exports(self, mock_hpo_error, mock_warm_start, mock_meta_features, mock_optuna):
