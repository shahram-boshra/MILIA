...
class TestLossRegistry:
    ...
    def test_registry_has_expected_losses(self):
        ...
        expected_losses = [
            # Regression losses
            "mse", "mae", "l1", "huber", "smooth_l1", "rmse", "weighted_mse",
            # Classification losses
            "cross_entropy", "ce", "nll", "bce", "bce_with_logits", "focal",
            # Multi-label losses
            "multilabel_soft_margin",
            # Ranking losses
            "margin_ranking", "triplet_margin",
            # Other losses
    ...
    def test_registry_losses_are_valid_classes(self):
        ...
        for name, loss_cls in LossRegistry._losses.items():
            ...
            assert issubclass(loss_cls, nn.Module), \
                f"Loss {name} is not a subclass of nn.Module"
...
class TestGetLoss:
    ...
    def test_get_loss_logging_with_params(self, caplog):
        ...
        assert any(
            "Initialized focal loss with params" in record.message 
...
class TestGetLossForTask:
    ...
    def test_get_loss_for_task_all_classification_tasks_return_cross_entropy(self):
        ...
        classification_tasks = ['graph_classification', 'node_classification', 'edge_classification']
    ...
    def test_get_loss_for_task_all_regression_tasks_return_mse(self):
        ...
        for task in regression_tasks:
            loss_fn = LossRegistry.get_loss_for_task(task)
            assert isinstance(loss_fn, nn.MSELoss), \
                f"Task '{task}' should auto-select MSELoss"
    ...
    def test_get_loss_for_task_classification_with_regression_loss_warning(self, caplog):
        ...
        warning_logged = any(
            "classification" in record.message.lower() and 
            "mse" in record.message.lower() and
    ...
    def test_get_loss_for_task_regression_with_classification_loss_warning(self, caplog):
        ...
        # Check warning message content
        warning_logged = any(
            "regression" in record.message.lower() and 
            "cross_entropy" in record.message.lower() and
...
class TestIsLossCompatibleWithTask:
    ...
    def test_cross_entropy_compatible_with_classification(self):
        ...
        assert LossRegistry.is_loss_compatible_with_task('cross_entropy', 'node_classification') is True
    ...
    def test_cross_entropy_not_compatible_with_regression(self):
        ...
        assert LossRegistry.is_loss_compatible_with_task('cross_entropy', 'node_regression') is False
    ...
    def test_bce_compatible_with_link_prediction(self):
        ...
        assert LossRegistry.is_loss_compatible_with_task('bce_with_logits', 'link_prediction') is True
    ...
    def test_all_classification_losses_compatible_with_classification(self):
        ...
        for loss_name in classification_losses:
            assert LossRegistry.is_loss_compatible_with_task(loss_name, 'graph_classification') is True
...
class TestRegisterCustomLoss:
    ...
    def test_register_custom_loss_logging(self, reset_loss_registry, caplog):
        ...
        assert any("Registered custom loss: 'custom'" in record.message 
                   for record in caplog.records)
...
class TestAllLosses:
    ...
    def test_all_classification_losses_instantiate(self):
        ...
        classification_losses = ["cross_entropy", "ce", "nll", "bce", 
