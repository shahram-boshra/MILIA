...
def _import_data_splitting_module():
    ...
    candidate_paths = [
        ...
        test_file_dir.parent / "src" / "milia_pipeline" / "models" / "training" / "data_splitting.py",
...
class TestRandomSplit:
    ...
    def test_random_split_reproducibility_with_seed(self, simple_dataset):
        ...
        train1, val1, test1 = DataSplitter.random_split(
            simple_dataset, random_seed=42
        )
        train2, val2, test2 = DataSplitter.random_split(
            simple_dataset, random_seed=42
        )
    ...
    def test_random_split_different_seeds_produce_different_splits(self, simple_dataset):
        ...
        train2, val2, test2 = DataSplitter.random_split(
            simple_dataset, random_seed=123
        )
    ...
    def test_random_split_shuffle_true(self, simple_dataset):
        ...
        train, val, test = DataSplitter.random_split(
            simple_dataset, shuffle=True, random_seed=42
        )
...
def _create_mock_sklearn_import(mock_train_test_split_func):
    ...
    """
    real_import = __builtins__.__import__ if isinstance(__builtins__, dict) else __builtins__.__dict__['__import__']
...
class TestStratifiedSplit:
    ...
    def test_stratified_split_reproducibility(self, labeled_dataset):
        ...
        try:
            ...
            train1, val1, test1 = DataSplitter.stratified_split(
                labeled_dataset, random_seed=42
            )
            train2, val2, test2 = DataSplitter.stratified_split(
                labeled_dataset, random_seed=42
            )
    ...
    def test_stratified_split_different_seeds(self, labeled_dataset):
        ...
        try:
            ...
            train2, val2, test2 = DataSplitter.stratified_split(
                labeled_dataset, random_seed=123
            )
...
class TestScaffoldSplit:
    ...
    def test_scaffold_split_reproducibility(self, molecular_dataset):
        ...
        train1, val1, test1 = DataSplitter.scaffold_split(
            molecular_dataset, random_seed=42
        )
        train2, val2, test2 = DataSplitter.scaffold_split(
            molecular_dataset, random_seed=42
        )
...
class TestKFoldSplit:
    ...
    def test_k_fold_split_reproducibility(self, simple_dataset):
        """Test reproducibility with same seed."""
        folds1 = DataSplitter.k_fold_split(
            simple_dataset, n_splits=5, random_seed=42
        )
        folds2 = DataSplitter.k_fold_split(
            simple_dataset, n_splits=5, random_seed=42
        )
    ...
    def test_k_fold_split_different_seeds(self, simple_dataset):
        ...
        folds2 = DataSplitter.k_fold_split(
            simple_dataset, n_splits=5, random_seed=123
        )
