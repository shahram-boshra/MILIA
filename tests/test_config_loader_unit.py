...
warnings.filterwarnings(
    'ignore',
    message='config_schemas not available.*',
...
def create_invalid_config():
    ...
    return {
        'project_name': 'test_project',
        'transformations': 'invalid_string'
    }
...
class TestPhase5RegistryIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self._original_registry_initializing = getattr(loader_module, '_REGISTRY_INITIALIZING', False)
...
class TestPhase5CreateExampleConfig(unittest.TestCase):
    ...
    def test_create_example_config_preserves_other_params(self):
        ...
        result = create_example_config(
            ...
            dataset_type='DFT',
            include_experimental_setups=False
        )
...
class TestStandardTransformsSupport(unittest.TestCase):
    ...
    def test_validate_enhanced_standard_transforms_not_list(self):
        ...
        transforms_section = {
            'standard_transforms': {'not': 'a list'},
            'default_setup': 'baseline'
        }
    ...
    def test_recommend_validation_level_complex_both_sources(self):
        ...
        config = {
            'transformations': {
                'standard_transforms': [
                    {'name': f'Transform{i}', 'kwargs': {}} for i in range(10)
                ],
                'experimental_setups': {
                    f'setup_{i}': [
                        {'name': f'SetupTransform{j}', 'kwargs': {}} for j in range(5)
                    ] for i in range(5)
                },
...
class TestConfigurationStatisticsEdgeCases(unittest.TestCase):
    ...
    def test_statistics_all_required_fields_present(self):
        ...
        required_fields = [
            'load_count', 'cache_hits', 'enhancement_applied',
            'migration_applied', 'validation_enabled', 'validation_level',
            'last_load_time', 'last_validation_time', 'last_validation_results',
            'last_migration_report', 'cache_hit_rate', 'config_cached',
