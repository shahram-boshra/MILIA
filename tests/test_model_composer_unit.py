...
class TestModelSpec:
    ...
    def test_init_with_parameters(self, simple_model):
        ...
        spec = ModelSpec(model=simple_model, weight=0.75, name="TestModel", level=2)
    ...
    def test_to_dict_with_name(self, simple_model):
        ...
        spec = ModelSpec(model=simple_model, weight=0.8, name="CustomName", level=0)
        result = spec.to_dict()
...
class TestEnsembleConfig:
    ...
    def test_init_basic(self):
        ...
        config = EnsembleConfig(name="TestEnsemble", task_type="graph_regression")
...
class TestCompositionError:
    ...
    def test_init_with_parameters(self):
        ...
        error = CompositionError(
            message="Test error", strategy="parallel", num_models=3, details="Additional details"
        )
    ...
    def test_str_with_details(self):
        ...
        error = CompositionError("Test error", details="Additional context")
        result = str(error)
...
class TestModelComposerInitialization:
    ...
    def test_init_with_name(self):
        ...
        composer = ModelComposer(task_type="node_classification", name="MyEnsemble")
...
class TestModelManagement:
    ...
    def test_add_model_method_chaining(self, sample_models):
        ...
        result = (
            composer.add_model(sample_models[0], weight=0.5)
...
class TestConfiguration:
    ...
    def test_configuration_chaining(self):
        ...
        result = composer.set_strategy("sequential").set_fusion("mean")
...
class TestBuild:
    ...
    def test_build_normalizes_weights(self, sample_models):
        ...
        assert torch.allclose(ensemble.weights.sum(), torch.tensor(1.0), atol=1e-5)
...
class TestConfigImportExport:
    ...
    def test_config_roundtrip(self, sample_models):
        ...
        original = ModelComposer(task_type="graph_regression", name="RoundtripTest")
        for model in sample_models:
...
class TestParallelEnsemble:
    ...
    def test_init_basic(self, sample_models):
        ...
        ensemble = ParallelEnsemble(
            models=sample_models, weights=weights, fusion="mean", task_type="graph_regression"
        )

        assert len(ensemble.models) == 3
        assert torch.allclose(ensemble.weights, torch.tensor(weights, dtype=torch.float32))
    ...
    def test_forward_mean_fusion(self, sample_input):
        ...
        ensemble = ParallelEnsemble(
            models=models, weights=[0.33, 0.33, 0.34], fusion="mean", task_type="graph_regression"
        )
    ...
    def test_forward_weighted_fusion(self, sample_input):
        ...
        ensemble = ParallelEnsemble(
            models=models, weights=[0.5, 0.3, 0.2], fusion="weighted", task_type="graph_regression"
        )
...
class TestSequentialStack:
    ...
    def test_init_with_name(self, sample_models):
        """Test initialization with custom name."""
        stack = SequentialStack(models=sample_models[:2], name="CustomStack")
    ...
    def test_forward_fallback_signatures(self, sample_input):
        """Test forward with models that have different signatures."""
        models = [SimpleGraphModel(), MinimalModel()]
    ...
    def test_repr(self, sample_models):
        """Test __repr__ method."""
        stack = SequentialStack(models=sample_models[:2], name="TestStack")
...
class TestHierarchicalComposition:
    ...
    def test_init_basic(self, sample_models):
        ...
        hierarchy = HierarchicalComposition(
            levels_dict=levels_dict, fusion="mean", task_type="graph_regression"
        )
    ...
    def test_init_with_multiple_models_per_level(self, sample_models):
        ...
        hierarchy = HierarchicalComposition(
            levels_dict=levels_dict, fusion="weighted", task_type="graph_regression"
        )
    ...
    def test_init_normalizes_weights_per_level(self, sample_models):
        ...
        assert torch.allclose(level0_ensemble.weights.sum(), torch.tensor(1.0), atol=1e-5)
...
class TestIntegration:
    ...
    def test_complete_parallel_workflow(self, sample_input):
        ...
        composer = ModelComposer(task_type="graph_regression", name="ParallelTest")
...
class TestParallelEnsembleInternalMethods:
    ...
    def test_is_graph_level_task_none(self, sample_models):
        ...
        ensemble = ParallelEnsemble(
            models=sample_models, weights=[0.33, 0.33, 0.34], fusion="mean", task_type=None
        )
    ...
    def test_get_innermost_model_unwrapped(self, simple_model):
        ...
        ensemble = ParallelEnsemble(
            models=[simple_model], weights=[1.0], fusion="mean", task_type="graph_regression"
        )
    ...
    def test_get_innermost_model_wrapped(self, simple_model):
        ...
        ensemble = ParallelEnsemble(
            models=[wrapped], weights=[1.0], fusion="mean", task_type="graph_regression"
        )
    ...
    def test_get_innermost_model_double_wrapped(self, simple_model):
        ...
        ensemble = ParallelEnsemble(
            models=[wrapped2], weights=[1.0], fusion="mean", task_type="graph_regression"
        )
...
class TestSequentialStackInternalMethods:
    ...
    def test_is_graph_level_task_true(self, sample_models):
        """Test _is_graph_level_task returns True for graph tasks."""
        stack = SequentialStack(models=sample_models[:2], task_type="graph_regression")

        assert stack._is_graph_level_task() is True

    def test_is_graph_level_task_false(self, sample_models):
        """Test _is_graph_level_task returns False for non-graph tasks."""
        stack = SequentialStack(models=sample_models[:2], task_type="node_classification")

        assert stack._is_graph_level_task() is False

    def test_is_graph_level_task_none(self, sample_models):
        """Test _is_graph_level_task returns False when task_type is None."""
        stack = SequentialStack(models=sample_models[:2], task_type=None)
...
class Test3DModelSupport:
    ...
    def test_is_3d_model_detection_in_parallel_ensemble(self, sample_models):
        ...
        ensemble = ParallelEnsemble(
            models=[model_3d], weights=[1.0], fusion="mean", task_type="graph_regression"
        )
...
class TestEdgeAttrSupport:
    ...
    def test_model_supports_edge_attr_with_attribute(self, sample_models):
        ...
        ensemble = ParallelEnsemble(
            models=[GATLikeModel()], weights=[1.0], fusion="mean", task_type="graph_regression"
        )
    ...
    def test_edge_attr_skipped_for_unsupported_model(self, sample_input):
        ...
        ensemble = ParallelEnsemble(
            models=[model], weights=[1.0], fusion="mean", task_type="graph_regression"
        )
...
class TestAutoencoderSupport:
    ...
    def test_tuple_output_handled(self, sample_input):
        ...
        ensemble = ParallelEnsemble(
            models=[MockVGAETuple()], weights=[1.0], fusion="mean", task_type="graph_regression"
        )
...
class TestEdgeLevelTasks:
    ...
    def test_edge_label_index_passed_to_model(self, sample_input):
        ...
        ensemble = ParallelEnsemble(
            models=[model], weights=[1.0], fusion="mean", task_type="link_prediction"
        )

        # Create edge_label_index
        edge_label_index = torch.randint(0, 20, (2, 10))

        ensemble(sample_input["x"], sample_input["edge_index"], edge_label_index=edge_label_index)
    ...
    def test_hierarchical_edge_label_index_last_level_only(self, sample_models, sample_input):
        ...
        hierarchy = HierarchicalComposition(
            levels_dict=levels_dict, fusion="mean", task_type="link_prediction"
        )
        ...
        output = hierarchy(
            sample_input["x"], sample_input["edge_index"], edge_label_index=edge_label_index
        )
...
class TestGlobalPooling:
    ...
    def test_pooling_method_mean(self, sample_input):
        ...
        ensemble = ParallelEnsemble(
            models=models, weights=[0.5, 0.5], fusion="mean", task_type="graph_regression"
        )
...
class TestMultiBatchGraphProcessing:
    ...
    def test_sequential_stack_graph_level(self):
        ...
        stack = SequentialStack(models=models, task_type="graph_regression")
...
class TestErrorRecovery:
    ...
    def test_model_forward_error_logged(self, sample_input):
        ...
        ensemble = ParallelEnsemble(
            models=[FailingModel()], weights=[1.0], fusion="mean", task_type="graph_regression"
        )
    ...
    def test_sequential_stack_model_error(self, sample_input):
        ...
        stack = SequentialStack(
            models=[SimpleModel(), FailingModel()], task_type="graph_regression"
        )
...
class TestPydanticV2Models:
    ...
    def test_ensemble_config_nested_arbitrary_types(self, simple_model):
        ...
        config = EnsembleConfig(name="Test", task_type="graph_regression", models=model_specs)
...
class TestWeightedFusionNormalization:
    ...
    def test_weights_normalized_at_build_time(self, sample_models):
        ...
        assert torch.allclose(
            ensemble.weights[0] / ensemble.weights[1], torch.tensor(2.0 / 3.0), atol=1e-5
        )
    ...
    def test_already_normalized_weights_unchanged(self, sample_models):
        ...
        # Should remain as-is
        assert torch.allclose(ensemble.weights, torch.tensor([0.4, 0.6]), atol=1e-5)
...
class TestComprehensiveIntegration:
    ...
    def test_full_workflow_with_validation_and_config(self, sample_input):
        ...
        # 1. Create composer
        composer = ModelComposer(task_type="graph_regression", name="FullWorkflowTest")
...
class TestSequentialStackCallModelWithSignature:
    ...
    def test_sequential_call_with_edge_attr(self, sample_input):
        ...
        stack = SequentialStack(
            models=[EdgeAttrModel(), EdgeAttrModel()], task_type="graph_regression"
        )
