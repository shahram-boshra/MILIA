...
class TestArchitectureConfig:
    ...
    def test_architecture_config_creation_full(self):
        ...
        residuals = [
            ResidualConnection(start_layer=0, end_layer=2)
        ]
    ...
    def test_architecture_config_from_dict(self):
        ...
        data = {
            ...
            'residual_connections': [
                {'start_layer': 0, 'end_layer': 2, 'connection_type': 'add'}
            ]
        }
    ...
    def test_architecture_config_nested_model_validation(self):
        ...
        config = ArchitectureConfig(
            ...
            out_channels=1,
            layers=[
                {"type": "GCNConv", "params": {}, "position": 0}
            ],
            residual_connections=[
...
class TestArchitectureBuilderValidation:
    ...
    def test_validate_channel_mismatch(self, mock_registry):
        ...
        mock_registry.get_layer_metadata.side_effect = [
            mock_meta1, mock_meta2,  # For _infer_channels
            mock_meta1, mock_meta2,  # For validation loop
            mock_meta1, mock_meta2   # For pooling check
        ]
        ...
        assert any("mismatch" in err.lower() or "pooling" in err.lower() for err in result['errors'])
    ...
    def test_validate_valid_architecture(self, mock_registry):
        ...
        mock_registry.get_layer_metadata.side_effect = [
            mock_meta_conv, mock_meta_pool, mock_meta_linear,  # For _infer_channels
            mock_meta_conv, mock_meta_pool,  # For validation loop - first pair
            mock_meta_pool, mock_meta_linear,  # For validation loop - second pair
            mock_meta_conv, mock_meta_pool, mock_meta_linear   # For pooling check
        ]
...
class TestArchitectureBuilderBuild:
    ...
    def test_build_passes_correct_params(self, mock_custom_arch, mock_registry):
        ...
        builder = ArchitectureBuilder("graph_regression", in_channels=16, out_channels=1, name="TestModel")
        builder.registry = mock_registry
...
class TestArchitectureBuilderConfigImportExport:
    ...
    def test_from_config_object(self, mock_registry):
        ...
        config = ArchitectureConfig(
            ...
            residual_connections=[
                ResidualConnection(start_layer=0, end_layer=1)
            ]
        )
    ...
    def test_from_config_dict(self, mock_registry):
        ...
        config_dict = {
            ...
            'residual_connections': [
                {'start_layer': 0, 'end_layer': 1, 'connection_type': 'add'}
            ]
        }
...
class TestCustomArchitecture:
    ...
    def test_custom_architecture_build_layers_error(self, mock_registry):
        ...
        layers = [
            LayerConfig(type="GCNConv", params={"wrong_param": 123}, position=0)
        ]
    ...
    def test_custom_architecture_forward_residual_add(self, mock_registry):
        ...
        residuals = [
            ResidualConnection(start_layer=0, end_layer=1, connection_type="add")
        ]
    ...
    def test_custom_architecture_forward_residual_concat(self, mock_registry):
        ...
        residuals = [
            ResidualConnection(start_layer=0, end_layer=1, connection_type="concat")
        ]
    ...
    def test_custom_architecture_forward_functional_layer(self, mock_registry):
        ...
        layers = [
            LayerConfig(type="global_mean_pool", params={}, position=0)
        ]
    ...
    def test_custom_architecture_forward_requires_batch_only(self, mock_registry):
        ...
        layers = [
            LayerConfig(type="BatchNorm1d", params={"num_features": 16}, position=0)
        ]
    ...
    def test_custom_architecture_forward_error_handling(self, mock_registry):
        ...
        layers = [
            LayerConfig(type="BrokenLayer", params={}, position=0)
        ]
    ...
    def test_custom_architecture_build_layers_functional_error_message(self, mock_registry):
        ...
        layers = [
            LayerConfig(type="global_mean_pool", params={"invalid_param": 123}, position=0)
        ]
        
        mock_layer_class = Mock(side_effect=TypeError("unexpected keyword argument 'invalid_param'"))
        mock_registry.get_layer.return_value = mock_layer_class
...
class TestEdgeCases:
    ...
    def test_method_chaining(self, mock_registry):
        ...
        result = (builder
                  .add_layer("GCNConv", out_channels=64)
                  .add_layer("ReLU")
