...
class TestDistributedConfig:
    ...
    def test_to_dict_includes_all_fields(self):
        ...
        expected_keys = [
            ...
            'gradient_as_bucket_view', 'static_graph', 'cpu_offload',
            'mixed_precision'
        ]
...
class TestDistributedManagerInitialization:
    ...
    def test_silent_initialization(self, caplog, clean_env):
        ...
        init_logs = [r for r in caplog.records 
                     if "DistributedManager initialized" in r.message]
    ...
    def test_wrap_model_dp_wraps_with_dataparallel(self, simple_model, clean_env):
        ...
        with patch('torch.cuda.is_available', return_value=True):
            with patch('torch.cuda.device_count', return_value=2):
                ...
                with patch('milia_pipeline.models.acceleration.distributed_strategies.DataParallel') as mock_dp:
    ...
    def test_wrap_model_ddp_moves_model_to_device(self, clean_env):
        ...
        with patch.object(dist, 'is_initialized', return_value=True):
            with patch('torch.cuda.is_available', return_value=True):
                ...
                with patch('milia_pipeline.models.acceleration.distributed_strategies.DistributedDataParallel') as mock_ddp:
...
class TestSaveCheckpoint:
    ...
    def test_save_checkpoint_not_main_process_skips(self, simple_model, temp_checkpoint_dir, clean_env):
    ...
    def test_save_checkpoint_contains_model_state(self, simple_model, temp_checkpoint_dir, clean_env):
    ...
    def test_save_checkpoint_contains_distributed_config(self, simple_model, temp_checkpoint_dir, clean_env):
    ...
    def test_save_checkpoint_logs_on_verbose(self, caplog, simple_model, temp_checkpoint_dir, clean_env):
...
class TestLoadCheckpoint:
    ...
    def test_load_checkpoint_loads_optimizer_state(self, simple_model, temp_checkpoint_dir, clean_env):
        ...
        checkpoint_path = temp_checkpoint_dir / "checkpoint.pt"
        manager.save_checkpoint(simple_model, checkpoint_path, include_optimizer=True, optimizer=optimizer)
    ...
    def test_load_checkpoint_returns_checkpoint_dict(self, simple_model, temp_checkpoint_dir, clean_env):
    ...
    def test_load_checkpoint_logs_on_verbose_main_process(self, caplog, simple_model, temp_checkpoint_dir, clean_env):
    ...
    def test_load_checkpoint_no_optimizer_state_in_checkpoint(self, simple_model, temp_checkpoint_dir, clean_env):
    ...
    def test_load_checkpoint_not_main_process_still_loads(self, simple_model, temp_checkpoint_dir, clean_env):
        ...
        with patch.dict('sys.modules', {
            ...
            with patch('torch.cuda.current_device', return_value=0):
                ...
                with patch('builtins.__import__', side_effect=lambda name, *args, **kwargs: 
                           mock_fsdp_module if 'fsdp' in name and 'wrap' not in name
                           else mock_wrap_module if 'wrap' in name
...
class TestLogging:
    ...
    def test_setup_ddp_logs_on_verbose(self, caplog, clean_env):
        ...
        assert any("DDP" in record.message or "Initialized" in record.message 
