...
class TestComputationConfig:
    ...
    def test_to_dict(self):
        ...
        config = ComputationConfig(compile_model=True, compile_mode="reduce-overhead")
    ...
    def test_pydantic_model_dump_method(self):
        ...
        config = ComputationConfig(compile_model=True, compile_mode="max-autotune")
    ...
    def test_to_dict_uses_model_dump(self):
        ...
        config = ComputationConfig(compile_model=True, cudnn_benchmark=False)
...
class TestPydanticV2Validation:
    ...
    def test_string_field_accepts_string(self):
        ...
        config = ComputationConfig(compile_mode="reduce-overhead", fusion_strategy="aggressive")
...
class TestComputationOptimizerInitialization:
    ...
    def test_silent_initialization(self, caplog):
        ...
        optimizer_init_logs = [
            r for r in caplog.records if "ComputationOptimizer initialized" in r.message
        ]
...
class TestGlobalOptimizations:
    ...
    def test_apply_global_optimizations_cuda_cudnn_benchmark(self):
        ...
        try:
            with patch.object(torch.backends.cudnn, "is_available", return_value=True):
                optimizer = ComputationOptimizer(device=device, cudnn_benchmark=True, verbose=False)
    ...
    def test_apply_global_optimizations_cuda_deterministic(self):
        ...
        with patch.object(torch.backends.cudnn, "is_available", return_value=True):
            optimizer = ComputationOptimizer(device=device, cudnn_deterministic=True, verbose=False)
    ...
    def test_apply_global_optimizations_tf32(self):
        ...
        with patch.object(torch.backends.cudnn, "is_available", return_value=True):
            ...
            if hasattr(torch.backends.cuda, "matmul"):
                optimizer = ComputationOptimizer(device=device, use_tf32=True, verbose=False)
...
class TestModelCompilation:
    ...
    def test_compile_model_disabled_returns_original(self, simple_model):
        ...
        optimizer = ComputationOptimizer(
            compile_model=False, verbose=False, device=torch.device("cpu")
        )
    ...
    def test_compile_model_success(self, simple_model):
        ...
        optimizer = ComputationOptimizer(
            compile_model=True, compile_mode="default", verbose=False, device=torch.device("cpu")
        )
    ...
    def test_compile_model_with_dynamic_override(self, simple_model):
        ...
        optimizer = ComputationOptimizer(
            compile_model=True, compile_dynamic=False, verbose=False, device=torch.device("cpu")
        )
    ...
    def test_compile_model_logging(self, simple_model, caplog):
        ...
        optimizer = ComputationOptimizer(
            compile_model=True, verbose=True, device=torch.device("cpu")
        )
    ...
    def test_compile_model_all_modes_parametrized(self, simple_model, compile_mode):
        ...
        optimizer = ComputationOptimizer(
            compile_model=True, compile_mode=compile_mode, verbose=False, device=torch.device("cpu")
        )
    ...
    def test_compile_model_dynamic_fullgraph_combinations(self, simple_model, dynamic, fullgraph):
        ...
        optimizer = ComputationOptimizer(
            compile_model=True, compile_dynamic=dynamic, verbose=False, device=torch.device("cpu")
        )
...
class TestJITCompilation:
    ...
    def test_jit_script_model_disabled_returns_original(self, simple_model):
        ...
        optimizer = ComputationOptimizer(
            jit_compile=False, verbose=False, device=torch.device("cpu")
        )
    ...
    def test_jit_script_model_without_example_inputs(self, simple_model):
        ...
        optimizer = ComputationOptimizer(
            jit_compile=True, verbose=False, device=torch.device("cpu")
        )
...
class TestMemoryFormatOptimization:
    ...
    def test_convert_to_channels_last_disabled_returns_original(self, conv_model):
        ...
        optimizer = ComputationOptimizer(
            channels_last=False, verbose=False, device=torch.device("cpu")
        )
    ...
    def test_convert_to_channels_last_enabled(self, conv_model):
        ...
        optimizer = ComputationOptimizer(
            channels_last=True, verbose=False, device=torch.device("cpu")
        )
    ...
    def test_convert_to_channels_last_logging(self, conv_model, caplog):
        ...
        optimizer = ComputationOptimizer(
            channels_last=True, verbose=True, device=torch.device("cpu")
        )
...
class TestOptimizeModel:
    ...
    def test_optimize_model_moves_to_device(self, simple_model):
        ...
        device = torch.device("cpu")
        optimizer = ComputationOptimizer(verbose=False, device=device)
    ...
    def test_optimize_model_applies_torch_compile(self, simple_model):
        ...
        optimizer = ComputationOptimizer(
            compile_model=True, jit_compile=False, verbose=False, device=torch.device("cpu")
        )
    ...
    def test_optimize_model_skips_compile_for_jit(self, simple_model):
        ...
        optimizer = ComputationOptimizer(
            compile_model=True, jit_compile=True, verbose=False, device=torch.device("cpu")
        )
        ...
        with (
            patch.object(optimizer, "jit_script_model", return_value=real_scripted),
...
class TestBenchmarking:
    ...
    def test_benchmark_model_basic(self, simple_model, sample_input):
        ...
        results = optimizer.benchmark_model(
            simple_model, sample_input, num_iterations=10, warmup_iterations=2
        )
    ...
    def test_benchmark_model_sets_eval_mode(self, simple_model, sample_input):
        ...
        optimizer.benchmark_model(simple_model, sample_input, num_iterations=5, warmup_iterations=2)
    ...
    def test_benchmark_model_warmup_iterations(self, simple_model, sample_input):
        ...
        optimizer.benchmark_model(
            simple_model, sample_input, num_iterations=10, warmup_iterations=5
        )
    ...
    def test_benchmark_model_timing_consistency(self, simple_model, sample_input):
        ...
        results = optimizer.benchmark_model(
            simple_model, sample_input, num_iterations=50, warmup_iterations=10
        )
...
class TestCompareOptimizations:
    ...
    def test_compare_optimizations_empty_configs(self, simple_model, sample_input):
        ...
        results = optimizer.compare_optimizations(simple_model, sample_input, [], num_iterations=5)
...
class TestGraphOptimization:
    ...
    def test_optimize_graph_failure_returns_model(self, mock_jit_script_module):
        ...
        with patch.object(
            torch._C, "_jit_pass_inline", side_effect=Exception("Optimization failed")
        ):
            result = optimizer.optimize_graph(mock_jit_script_module, optimization_level=1)
...
class TestPrintOptimizationSummary:
    ...
    def test_print_optimization_summary_cuda(self, capsys):
        ...
        optimizer = ComputationOptimizer(
            cudnn_benchmark=True, use_tf32=True, verbose=False, device=torch.device("cuda")
        )
...
class TestConvenienceFunctions:
    ...
    def test_auto_optimize_model_training(self, simple_model):
        ...
        with patch(
            "milia_pipeline.models.acceleration.computation_optimization.ComputationOptimizer"
        ) as MockOptimizer:
...
class TestEdgeCases:
    ...
    def test_benchmark_with_zero_iterations(self, simple_model, sample_input):
        ...
        results = optimizer.benchmark_model(
            simple_model, sample_input, num_iterations=1, warmup_iterations=0
        )
    ...
    def test_multiple_optimizer_instances(self):
        ...
        with patch("torch.cuda.is_available", return_value=False):
            optimizer1 = ComputationOptimizer(compile_model=True, verbose=False)
            optimizer2 = ComputationOptimizer(compile_model=False, verbose=False)
    ...
    def test_device_type_string_handling(self):
        ...
        optimizer = ComputationOptimizer(device=device, verbose=False)
    ...
    def test_large_warmup_iterations(self, simple_model, sample_input):
        ...
        results = optimizer.benchmark_model(
            simple_model, sample_input, num_iterations=5, warmup_iterations=20
        )
    ...
    def test_benchmark_std_calculation(self, simple_model, sample_input):
        ...
        results = optimizer.benchmark_model(
            simple_model, sample_input, num_iterations=50, warmup_iterations=5
        )
    ...
    def test_optimizer_config_reference_integrity(self):
        ...
        with patch("torch.cuda.is_available", return_value=False):
            optimizer = ComputationOptimizer(
                compile_model=True, compile_mode="max-autotune", verbose=False
            )
...
class TestIntegration:
    ...
    def test_full_optimization_pipeline_cpu(self, simple_model, sample_input):
        ...
        # Benchmark
        results = optimizer.benchmark_model(
            optimized, sample_input, num_iterations=5, warmup_iterations=2
        )
    ...
    def test_config_to_optimizer_consistency(self):
        ...
        config = ComputationConfig(
            compile_model=True, compile_mode="max-autotune", cudnn_benchmark=False
        )
    ...
    def test_sequential_optimizations(self, simple_model, sample_input):
        ...
        results1 = optimizer.benchmark_model(
            simple_model, sample_input, num_iterations=3, warmup_iterations=1
        )
...
class TestCUDASpecific:
    ...
    def test_cuda_device_sync_in_benchmark(self):
        ...
        with patch.object(torch.cuda, "synchronize") as mock_sync:
            optimizer.benchmark_model(mock_model, input_data, num_iterations=3, warmup_iterations=1)
    ...
    def test_tf32_settings_on_cuda(self):
        ...
        with patch.object(torch.backends.cudnn, "is_available", return_value=True):
            optimizer = ComputationOptimizer(
                use_tf32=True, verbose=False, device=torch.device("cuda")
            )
    ...
    def test_multiple_optimizers_concurrent_config_access(self):
        ...
        def create_and_access_optimizer(compile_mode, results_list, errors_list):
            try:
                with patch("torch.cuda.is_available", return_value=False):
                    optimizer = ComputationOptimizer(
                        compile_model=True, compile_mode=compile_mode, verbose=False
                    )
        ...
        for mode in modes:
            t = threading.Thread(target=create_and_access_optimizer, args=(mode, results, errors))
            threads.append(t)
            t.start()
