...
def setup_module(module):
    ...
    spec = importlib.util.spec_from_file_location(
        "milia_pipeline.models.builders.layer_registry", layer_registry_path
    )
...
class TestFunctionalLayerWrapper:
    ...
    def test_init_basic(self):
        ...
        wrapper = FunctionalLayerWrapper(func=mock_func, func_name="test_func")
    ...
    def test_forward_with_batch(self):
        ...
        mock_func = Mock(return_value=torch.tensor([1.0]))
        wrapper = FunctionalLayerWrapper(
            func=mock_func, func_name="pooling_func", requires_batch=True
        )
    ...
    def test_forward_with_edge_index(self):
        ...
        mock_func = Mock(return_value=torch.tensor([1.0]))
        wrapper = FunctionalLayerWrapper(
            func=mock_func, func_name="conv_func", requires_edge_index=True
        )
    ...
    def test_forward_with_edge_index_and_attr(self):
        ...
        mock_func = Mock(return_value=torch.tensor([1.0]))
        wrapper = FunctionalLayerWrapper(
            func=mock_func, func_name="conv_func", requires_edge_index=True, requires_edge_attr=True
        )
...
class TestLayerMetadata:
    ...
    def test_supported_task_levels_default_factory(self):
        ...
        metadata1 = LayerMetadata(
            name="Layer1", category=LayerCategory.CUSTOM, class_path="custom", description="Test 1"
        )
        metadata2 = LayerMetadata(
            name="Layer2", category=LayerCategory.CUSTOM, class_path="custom", description="Test 2"
        )
...
class TestBuiltinLayerRegistration:
    ...
    def test_pooling_layers_registered(self):
        ...
        expected_functional_pooling = ["global_mean_pool", "global_max_pool", "global_add_pool"]
...
class TestRegisterCustomLayer:
    ...
    def test_register_custom_class_layer(self):
        ...
        registry.register_custom_layer(layer_name, CustomLayerClass, category=LayerCategory.CUSTOM)
    ...
    def test_register_custom_function_layer(self):
        ...
        registry.register_custom_layer(
            "custom_pool_func", custom_pool, metadata=metadata, category=LayerCategory.POOLING
        )
    ...
    def test_register_function_without_functional_metadata(self):
        ...
        registry.register_custom_layer(
            "my_pool_func_wrapped", my_pool_func, metadata=metadata, category=LayerCategory.POOLING
        )
    ...
    def test_register_with_auto_generated_metadata(self):
        ...
        registry.register_custom_layer(layer_name, SimpleLayerAuto, category=LayerCategory.CUSTOM)
    ...
    def test_register_duplicate_with_overwrite_succeeds(self):
        ...
        registry.register_custom_layer(
            layer_name, Layer2, category=LayerCategory.CUSTOM, overwrite=True
        )
    ...
    def test_register_custom_with_module_attribute(self):
        ...
        registry.register_custom_layer(
            "ModulePathTestLayer_v1", ModulePathTestLayer, category=LayerCategory.CUSTOM
        )
...
class TestInternalMethods:
    ...
    def test_create_functional_wrapper(self):
        ...
        wrapper_class = registry._create_functional_wrapper(
            "test_pool_wrapper", test_pool_func, metadata
        )
    ...
    def test_create_functional_wrapper_with_edge_requirements(self):
        ...
        wrapper_class = registry._create_functional_wrapper(
            "test_conv_wrapper", test_conv_func, metadata
        )
    ...
    def test_concurrent_registration(self):
        ...
        def register_layer(idx):
            try:
                ...
                registry.register_custom_layer(
                    f"ThreadLayer{idx}", TestLayer, category=LayerCategory.CUSTOM
                )
                results.append(True)
...
class TestIntegration:
    ...
    def test_custom_layer_workflow(self):
        ...
        # Register
        registry.register_custom_layer(
            layer_name, MyCustomConvWorkflow, category=LayerCategory.CUSTOM
        )
    ...
    def test_statistics_after_custom_registration(self):
        ...
        registry.register_custom_layer(
            "StatsTestLayer_v1", StatsTestLayer, category=LayerCategory.CUSTOM
        )
