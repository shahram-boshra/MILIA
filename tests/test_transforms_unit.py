...
class TestBaseTransformProtocol:
    ...
    @pytest.mark.parametrize("cls", [DropEdge, DropNode, MaskFeatures, RandomNodeSample],
    ...
    def test_implements_get_metadata(self, cls):
        ...
        assert isinstance(cls.__dict__.get('get_metadata'), classmethod) or callable(getattr(cls, 'get_metadata'))
    ...
    def test_metadata_list_fields_are_lists(self, cls):
        ...
        metadata = cls.get_metadata()
        for field_name in ['validated_datasets', 'required_node_features',
                           'required_edge_features', 'required_graph_attributes']:
