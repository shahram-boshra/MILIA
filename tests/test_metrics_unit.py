...
class TestRMSEMetric:
    ...
    def test_rmse_metric_fallback_when_torchmetrics_unavailable(
...
class TestMetricsRegistryGetMetric:
    ...
    def test_get_metric_accuracy_multiclass(self):
        ...
        metric = MetricsRegistry.get_metric(
            "accuracy", params={"task": "multiclass", "num_classes": 5}
        )
    ...
    def test_get_metric_with_valid_params(self):
        ...
        metric = MetricsRegistry.get_metric(
            "accuracy", params={"task": "multiclass", "num_classes": 3}
        )
...
class TestMetricsRegistryRegisterCustomMetric:
    ...
    def test_register_custom_metric_retrievable(self, mock_metric_class, cleanup_registry):
        ...
        MetricsRegistry.register_custom_metric(
            name="custom_retrievable", metric_class=mock_metric_class
        )
    ...
    def test_register_custom_metric_lowercase_name(self, mock_metric_class, cleanup_registry):
        ...
        MetricsRegistry.register_custom_metric(
            name="UPPERCASE_METRIC", metric_class=mock_metric_class
        )

        assert "uppercase_metric" in MetricsRegistry._metrics
        assert "UPPERCASE_METRIC" not in MetricsRegistry._metrics

    def test_register_custom_metric_added_to_classification(
        self, mock_metric_class, cleanup_registry
    ):
    ...
    def test_register_custom_metric_duplicate_raises_error(
        self, mock_metric_class, cleanup_registry
    ):
        """Test registering duplicate metric name raises ValueError."""
        MetricsRegistry.register_custom_metric(
            name="duplicate_test", metric_class=mock_metric_class
        )
    ...
    def test_register_custom_metric_overwrite(self, mock_metric_class, cleanup_registry):
        ...
        MetricsRegistry.register_custom_metric(
            name="overwrite_test", metric_class=mock_metric_class
        )

        # Should not raise with overwrite=True
        MetricsRegistry.register_custom_metric(
            name="overwrite_test", metric_class=mock_metric_class, overwrite=True
        )
    ...
    def test_register_custom_metric_invalid_type_raises_error(self, cleanup_registry):
        ...
        with pytest.raises(TypeError, match="must be a subclass"):
            MetricsRegistry.register_custom_metric(name="invalid_metric", metric_class=NotAModule)
    ...
    def test_register_custom_metric_not_a_class_raises_error(self, cleanup_registry):
        ...
        with pytest.raises(TypeError):
            MetricsRegistry.register_custom_metric(
                name="not_a_class", metric_class="string_not_class"
            )

    def test_register_custom_metric_instance_instead_of_type_raises_error(
        self, mock_metric_class, cleanup_registry
    ):
    ...
    def test_register_custom_metric_both_classification_and_regression(
        self, mock_metric_class, cleanup_registry
    ):
    ...
    @pytest.mark.skipif(not TORCHMETRICS_AVAILABLE, reason="TorchMetrics required")
    def test_register_torchmetrics_custom_metric(
        self, mock_torchmetrics_metric_class, cleanup_registry
    ):
        """Test registering a TorchMetrics-based custom metric."""
        MetricsRegistry.register_custom_metric(
            name="torchmetrics_custom", metric_class=mock_torchmetrics_metric_class
        )
...
class TestMetricsRegistryGetMetricsForTask:
    ...
    def test_get_metrics_for_task_with_explicit_metric_names(self):
        ...
        metrics = MetricsRegistry.get_metrics_for_task(
            "graph_regression", metric_names=["mae", "mse"]
        )
    ...
    def test_get_metrics_for_task_with_device(self):
        ...
        device = torch.device("cpu")
        metrics = MetricsRegistry.get_metrics_for_task("graph_regression", device=device)
    ...
    def test_get_metrics_for_task_with_num_classes(self):
        ...
        metrics = MetricsRegistry.get_metrics_for_task("graph_classification", num_classes=5)
    ...
    def test_get_metrics_for_task_empty_metric_names(self):
        ...
        metrics = MetricsRegistry.get_metrics_for_task("graph_regression", metric_names=[])
    ...
    def test_get_metrics_for_task_classification_with_num_classes_only(self):
        ...
        metrics_binary = MetricsRegistry.get_metrics_for_task("graph_classification", num_classes=2)
        ...
        metrics_multiclass = MetricsRegistry.get_metrics_for_task(
            "graph_classification", num_classes=5
        )
...
class TestMetricsRegistryIsMetricCompatibleWithTask:
    ...
    def test_accuracy_compatible_with_classification(self):
        ...
        assert (
            MetricsRegistry.is_metric_compatible_with_task("accuracy", "node_classification")
            is True
        )
...
class TestMetricsRegistryCreateMetricCollection:
    ...
    def test_create_metric_collection_classification(self):
        ...
        collection = MetricsRegistry.create_metric_collection("graph_classification", num_classes=2)
    ...
    def test_create_metric_collection_multiclass(self):
        ...
        collection = MetricsRegistry.create_metric_collection("node_classification", num_classes=5)
...
class TestLogging:
    ...
    def test_get_metrics_for_task_logs_warning_on_incompatible(self, caplog):
        ...
        assert any(
            "incompatible" in record.message.lower()
            for record in caplog.records
...
class TestTorchMetricsAvailability:
    ...
    @pytest.mark.skipif(
        not TORCHMETRICS_AVAILABLE, reason="TorchMetrics required for baseline test"
    )
...
class TestIntegration:
    ...
    def test_full_classification_workflow(
        self, sample_classification_preds, sample_classification_targets
    ):
        """Test full classification metric workflow."""
        # Get metrics for task
        metrics = get_metrics_for_task("graph_classification", num_classes=2)
    ...
    def test_custom_metric_registration_and_use(self, mock_metric_class, cleanup_registry):
        ...
        MetricsRegistry.register_custom_metric(
            name="custom_integration_test", metric_class=mock_metric_class, is_regression=True
        )
