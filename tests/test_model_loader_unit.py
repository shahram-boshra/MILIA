...
def create_configured_checkpoint_manager_mock(checkpoint, tmp_path):
    ...
    mock_cm_instance.is_v2_checkpoint.return_value = checkpoint.get('version_info', {}).get('checkpoint_format_version', '1.0') == '2.0'
...
class TestLoadInternalMethod:
    ...
    @patch('milia_pipeline.models.post_training.inference.model_loader.CheckpointManager')
    @patch('milia_pipeline.models.post_training.inference.model_loader.get_factory')
    def test_load_auto_detects_device_cuda(self, mock_get_factory, mock_cm_class, v2_checkpoint, tmp_path):
        ...
        with patch('milia_pipeline.models.post_training.inference.model_loader.torch.cuda.is_available', return_value=True):
            model, _ = ModelLoader.load_from_checkpoint("test.pt", working_root_dir=tmp_path, device=None)
    ...
    @patch('milia_pipeline.models.post_training.inference.model_loader.CheckpointManager')
    @patch('milia_pipeline.models.post_training.inference.model_loader.get_factory')
    def test_load_auto_detects_device_cpu(self, mock_get_factory, mock_cm_class, v2_checkpoint, tmp_path):
        ...
        with patch('milia_pipeline.models.post_training.inference.model_loader.torch.cuda.is_available', return_value=False):
            model, _ = ModelLoader.load_from_checkpoint("test.pt", working_root_dir=tmp_path, device=None)
    ...
    @patch('milia_pipeline.models.post_training.inference.model_loader.CheckpointManager')
    @patch('milia_pipeline.models.post_training.inference.model_loader.get_factory')
    def test_load_uses_specified_device(self, mock_get_factory, mock_cm_class, v2_checkpoint, tmp_path):
        ...
        model, _ = ModelLoader.load_from_checkpoint("test.pt", working_root_dir=tmp_path, device=specified_device)
    ...
    def test_load_extracts_hyper_parameters_from_checkpoint(
        ...
        assert call_kwargs['hyperparameters'] == v2_checkpoint['hyper_parameters']['hyperparameters']
    ...
    def test_load_extracts_target_selection_config(
        ...
        mock_cm_instance = create_configured_checkpoint_manager_mock(v2_checkpoint_with_target_selection, tmp_path)
        mock_cm_class.return_value = mock_cm_instance
        ...
        call_kwargs = mock_factory.create_model_with_info.call_args[1]
        expected_ts_config = v2_checkpoint_with_target_selection['hyper_parameters']['target_selection_config']
        assert call_kwargs['target_selection_config'] == expected_ts_config
    
    @patch('milia_pipeline.models.post_training.inference.model_loader.CheckpointManager')
    @patch('milia_pipeline.models.post_training.inference.model_loader.get_factory')
    def test_load_overrides_model_name(self, mock_get_factory, mock_cm_class, v2_checkpoint, tmp_path):
        ...
        model, _ = ModelLoader.load_from_checkpoint("test.pt", working_root_dir=tmp_path, model_name="GAT")
    ...
    @patch('milia_pipeline.models.post_training.inference.model_loader.CheckpointManager')
    @patch('milia_pipeline.models.post_training.inference.model_loader.get_factory')
    def test_load_overrides_task_type(self, mock_get_factory, mock_cm_class, v2_checkpoint, tmp_path):
        ...
        model, _ = ModelLoader.load_from_checkpoint("test.pt", working_root_dir=tmp_path, task_type="node_classification")
    ...
    @patch('milia_pipeline.models.post_training.inference.model_loader.CheckpointManager')
    @patch('milia_pipeline.models.post_training.inference.model_loader.get_factory')
    def test_load_overrides_hyperparameters(self, mock_get_factory, mock_cm_class, v2_checkpoint, tmp_path):
        ...
        model, _ = ModelLoader.load_from_checkpoint("test.pt", working_root_dir=tmp_path, hyperparameters=override_hyperparams)
    ...
    @patch('milia_pipeline.models.post_training.inference.model_loader.CheckpointManager')
    @patch('milia_pipeline.models.post_training.inference.model_loader.get_factory')
    def test_load_sets_model_to_eval_mode(self, mock_get_factory, mock_cm_class, v2_checkpoint, tmp_path):
    ...
    @patch('milia_pipeline.models.post_training.inference.model_loader.CheckpointManager')
    @patch('milia_pipeline.models.post_training.inference.model_loader.get_factory')
    def test_load_loads_state_dict_strict_mode(self, mock_get_factory, mock_cm_class, v2_checkpoint, tmp_path):
        ...
        model, _ = ModelLoader.load_from_checkpoint("test.pt", working_root_dir=tmp_path, strict=True)
    ...
    @patch('milia_pipeline.models.post_training.inference.model_loader.CheckpointManager')
    @patch('milia_pipeline.models.post_training.inference.model_loader.get_factory')
    def test_load_loads_state_dict_non_strict_mode(self, mock_get_factory, mock_cm_class, v2_checkpoint, tmp_path):
        ...
        model, _ = ModelLoader.load_from_checkpoint("test.pt", working_root_dir=tmp_path, strict=False)
...
class TestWrappedModelHandling:
    ...
    def test_load_state_dict_into_wrapped_model_on_mismatch(
        ...
        wrapped_state_dict = {
            f'model.{k}': v for k, v in v2_checkpoint['model_state_dict'].items()
        }
        ...
        outer_model.state_dict.return_value = {'layer1.weight': MagicMock(), 'layer1.bias': MagicMock()}
...
class TestModelInfoMerging:
    ...
    @patch('milia_pipeline.models.post_training.inference.model_loader.CheckpointManager')
    @patch('milia_pipeline.models.post_training.inference.model_loader.get_factory')
    def test_load_saved_model_info_takes_precedence(self, mock_get_factory, mock_cm_class, v2_checkpoint, tmp_path):
...
class TestGetCheckpointInfo:
    ...
    @patch('milia_pipeline.models.post_training.inference.model_loader.CheckpointManager')
    @patch('milia_pipeline.models.post_training.inference.model_loader.get_factory')
    def test_get_checkpoint_info_returns_dict(self, mock_get_factory, mock_cm_class, v2_checkpoint, tmp_path):
    ...
    @patch('milia_pipeline.models.post_training.inference.model_loader.CheckpointManager')
    @patch('milia_pipeline.models.post_training.inference.model_loader.get_factory')
    def test_get_checkpoint_info_extracts_is_v2(self, mock_get_factory, mock_cm_class, v2_checkpoint, tmp_path):
    ...
    @patch('milia_pipeline.models.post_training.inference.model_loader.CheckpointManager')
    @patch('milia_pipeline.models.post_training.inference.model_loader.get_factory')
    def test_get_checkpoint_info_extracts_epoch(self, mock_get_factory, mock_cm_class, v2_checkpoint, tmp_path):
...
class TestLoadModelFunction:
    ...
    @patch('milia_pipeline.models.post_training.inference.model_loader.ModelLoader.load_from_checkpoint')
...
class TestLogging:
    ...
    def test_module_logger_name(self, tmp_path):
        ...
        assert model_loader_logger.name == 'milia_pipeline.models.post_training.inference.model_loader'
    ...
    def test_load_logs_model_recreation_info(
        ...
        assert any("Recreating" in record.message and "GCN" in record.message 
...
class TestSpecialModelTypes:
    ...
    @patch('milia_pipeline.models.post_training.inference.model_loader.CheckpointManager')
    @patch('milia_pipeline.models.post_training.inference.model_loader.get_factory')
    def test_load_3d_model_checkpoint(self, mock_get_factory, mock_cm_class, sample_state_dict, tmp_path):
    ...
    @patch('milia_pipeline.models.post_training.inference.model_loader.CheckpointManager')
    @patch('milia_pipeline.models.post_training.inference.model_loader.get_factory')
    def test_load_ensemble_model_checkpoint(self, mock_get_factory, mock_cm_class, sample_state_dict, tmp_path):
