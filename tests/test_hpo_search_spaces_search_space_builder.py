...
class MockSearchSpaceParamConfig:
    ...
    def __init__(
        ...
        if self.type in (MockParamType.INT, MockParamType.FLOAT, MockParamType.LOGUNIFORM,
                         MockParamType.UNIFORM, MockParamType.INT_UNIFORM):
...
class MockPyGModelIntrospector:
    ...
    def __init__(self, available_models: Optional[List[str]] = None):
        self.available_models = available_models or [
            "GCN", "GAT", "GraphSAGE", "GIN", "SchNet", "DimeNet", "MPNN",
            "PMLP", "EdgeConv", "PointNet", "TransformerConv"
        ]
...
def search_space_builder_module(mock_exceptions, mock_param_types):
    ...
    with patch(
        'milia_pipeline.models.hpo.search_spaces.search_space_builder.ParamType',
        MockParamType
    ):
        with patch(
...
class TestSearchSpaceBuilderInit:
    ...
    def test_valid_categories_contains_expected_values(self, search_space_builder_module):
        ...
        assert SearchSpaceBuilder.VALID_CATEGORIES == expected
...
class TestSearchSpaceBuilderEnsureCategory:
    ...
    def test_ensure_category_does_not_overwrite_existing(self, builder, search_space_builder_module):
...
class TestSearchSpaceBuilderValidateCategory:
    ...
    def test_validate_category_all_valid_no_warning(self, builder, caplog):
        ...
        valid_categories = [
            ...
            "scheduler", "loss", "training", "architecture"
        ]
...
class TestSearchSpaceBuilderAddLoguniform:
    ...
    def test_add_loguniform_chaining(self, builder):
        ...
        result = (
            ...
            .add_loguniform("weight_decay", 1e-6, 1e-3)
        )
...
class TestSearchSpaceBuilderAddCategorical:
    ...
    def test_add_categorical_chaining(self, builder):
        ...
        result = (
            builder
            .add_categorical("activation", ["relu", "gelu"])
            .add_categorical("norm", ["batch", "layer"])
        )
...
class TestSearchSpaceBuilderAddUniform:
    ...
    def test_add_uniform_chaining(self, builder):
        ...
        result = (
            builder
            .add_uniform("param1", 0.0, 1.0)
            .add_uniform("param2", -1.0, 1.0)
        )
...
class TestSearchSpaceBuilderAddDiscreteUniform:
    ...
    def test_add_discrete_uniform_chaining(self, builder):
        ...
        result = (
            builder
            .add_discrete_uniform("param1", 0, 100, step=10)
            .add_discrete_uniform("param2", 16, 128, step=16)
        )
...
class TestSearchSpaceBuilderAddParam:
    ...
    def test_add_param_default_category_is_hyperparameters(self, builder, search_space_builder_module):
    ...
    def test_add_param_chaining(self, builder, search_space_builder_module):
        ...
        result = (
            builder
            .add_param("param1", {"type": "int", "low": 1, "high": 10})
            .add_param("param2", {"type": "float", "low": 0.0, "high": 1.0})
        )
...
class TestSearchSpaceBuilderAddCategory:
    ...
    def test_add_category_multiple_categories(self, builder):
        ...
        builder.add_category("scheduler", {
    ...
    def test_add_category_chaining(self, builder):
        ...
        result = (
            builder
            .add_category("optimizer", {"lr": {"type": "loguniform", "low": 1e-5, "high": 1e-2}})
    ...
    def test_add_category_validates_category_name(self, builder, caplog):
        ...
        builder.add_category("non_standard_category", {
            "param": {"type": "int", "low": 1, "high": 10}
        })
...
class TestSearchSpaceBuilderForModelLegacy:
    ...
    def test_for_model_gcn_case_insensitive(self, search_space_builder_module):
        ...
        with patch(
            ...
            assert set(result_upper["hyperparameters"].keys()) == set(result_lower["hyperparameters"].keys())
            assert set(result_upper["hyperparameters"].keys()) == set(result_mixed["hyperparameters"].keys())
...
class TestSearchSpaceBuilderFromDict:
    ...
    def test_from_dict_with_log(self, search_space_builder_module):
        ...
        space_dict = {
            "hyperparameters": {
                "temp": {"type": "float", "low": 0.01, "high": 1.0, "log": True}
            }
        }
...
class TestSearchSpaceBuilderMerge:
    ...
    def test_merge_different_categories(self, search_space_builder_module):
        ...
        space1 = (
            SearchSpaceBuilder()
            .add_int("hidden", 32, 256, category="hyperparameters")
            .build()
        )
        space2 = (
            SearchSpaceBuilder()
...
class TestSearchSpaceBuilderValidate:
    ...
    def test_validate_with_searchspaceparamconfig_objects(self, search_space_builder_module):
        ...
        valid_space = {
            "hyperparameters": {
                "param": SearchSpaceParamConfig(type=ParamType.INT, low=1, high=10)
            }
        }
...
class TestSearchSpaceBuilderEstimateSearchSpaceSize:
    ...
    def test_estimate_search_space_size_continuous_uses_grid_points(self, search_space_builder_module):
    ...
    def test_estimate_search_space_size_loguniform_uses_grid_points(self, search_space_builder_module):
    ...
    def test_estimate_search_space_size_categorical_empty_choices(self, search_space_builder_module):
        ...
        space = {
            "hyperparameters": {
                "param": MagicMock(type=RealParamType.CATEGORICAL, choices=None)
            }
        }
...
class TestSearchSpaceBuilderListAvailableModels:
    ...
    def test_list_available_models_introspection_failure_falls_back(self, search_space_builder_module, caplog):
...
class TestSearchSpaceBuilderForModelDynamic:
    ...
    def test_for_model_dynamic_model_not_found_falls_back(self, search_space_builder_module, caplog):
...
class TestValidateSearchSpaceFunction:
    ...
    def test_validate_search_space_wraps_validate(self, search_space_builder_module, sample_search_space):
