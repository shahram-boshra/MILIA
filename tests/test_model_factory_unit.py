...
def mock_torch_module():
    ...
    class MockModel(torch.nn.Module):
        def __init__(self, in_channels=10, out_channels=5, hidden_channels=32, 
...
class TestModelValidatorDataCompatibility:
    ...
    def test_missing_edge_attr_raises_error(self, model_validator, sample_metadata):
        ...
        with pytest.raises(DataCompatibilityError) as exc_info:
            model_validator.validate_data_compatibility(data, sample_metadata)
        assert "edge_attr" in str(exc_info.value).lower() or "edge features" in str(exc_info.value).lower()
    ...
    def test_missing_edge_weight_raises_error(self, model_validator, sample_metadata):
        ...
        with pytest.raises(DataCompatibilityError) as exc_info:
            model_validator.validate_data_compatibility(data, sample_metadata)
        assert "edge_weight" in str(exc_info.value).lower() or "edge weights" in str(exc_info.value).lower()
    ...
    def test_heterogeneous_graph_without_support_raises_error(self, model_validator, sample_metadata):
...
class TestModelFactoryCreateModel:
    ...
    def test_unsupported_task_type_raises_error(self, mock_get_metadata, mock_registry_class, mock_torch_module, sample_metadata):
    ...
    @patch('milia_pipeline.models.factory.model_factory.ModelRegistry')
    @patch('milia_pipeline.models.factory.model_factory.get_model_metadata')
    def test_successful_model_creation(self, mock_get_metadata, mock_registry_class, mock_torch_module, sample_metadata):
    ...
    @patch('milia_pipeline.models.factory.model_factory.ModelRegistry')
    @patch('milia_pipeline.models.factory.model_factory.get_model_metadata')
    def test_model_moved_to_device(self, mock_get_metadata, mock_registry_class, mock_torch_module, sample_metadata):
    ...
    @patch('milia_pipeline.models.factory.model_factory.ModelRegistry')
    @patch('milia_pipeline.models.factory.model_factory.get_model_metadata')
    def test_model_instantiation_failure_raises_error(self, mock_get_metadata, mock_registry_class, sample_metadata):
...
class TestModelFactoryHyperparameterProcessing:
    ...
    @patch('milia_pipeline.models.factory.model_factory.ModelRegistry')
    @patch('milia_pipeline.models.factory.model_factory.get_model_metadata')
    def test_in_channels_inferred_from_sample_data(self, mock_get_metadata, mock_registry_class, mock_torch_module, sample_metadata):
    ...
    @patch('milia_pipeline.models.factory.model_factory.ModelRegistry')
    @patch('milia_pipeline.models.factory.model_factory.get_model_metadata')
    def test_out_channels_inferred_for_regression(self, mock_get_metadata, mock_registry_class, mock_torch_module, sample_metadata):
    ...
    @patch('milia_pipeline.models.factory.model_factory.ModelRegistry')
    @patch('milia_pipeline.models.factory.model_factory.get_model_metadata')
    def test_out_channels_inferred_for_classification(self, mock_get_metadata, mock_registry_class, mock_torch_module, sample_metadata):
    ...
    @patch('milia_pipeline.models.factory.model_factory.ModelRegistry')
    @patch('milia_pipeline.models.factory.model_factory.get_model_metadata')
    def test_out_channels_inferred_for_multi_label_classification(self, mock_get_metadata, mock_registry_class, mock_torch_module, sample_metadata):
    ...
    @patch('milia_pipeline.models.factory.model_factory.ModelRegistry')
    @patch('milia_pipeline.models.factory.model_factory.get_model_metadata')
    def test_default_values_applied(self, mock_get_metadata, mock_registry_class, mock_torch_module, sample_metadata):
...
class TestModelFactoryParameterFiltering:
    ...
    def test_filtering_logs_filtered_params(
        self, mock_get_metadata, mock_registry_class, mock_logger, mock_torch_module, sample_metadata
    ):
...
class TestModelFactoryParameterFilteringEdgeCases:
    ...
    @patch('milia_pipeline.models.factory.model_factory.ModelRegistry')
    @patch('milia_pipeline.models.factory.model_factory.get_model_metadata')
    def test_filtering_with_only_non_schema_params(
        self, mock_get_metadata, mock_registry_class
    ):
        ...
        class DefaultsModel(torch.nn.Module):
            def __init__(self, in_channels=10, hidden_channels=64,
                         out_channels=1, num_layers=2, dropout=0.0, act='relu'):
                super().__init__()
                self.in_channels = in_channels
                self.hidden_channels = hidden_channels
                self.out_channels = out_channels
...
class TestModelFactoryGetModelInfo:
    ...
    @patch('milia_pipeline.models.factory.model_factory.ModelRegistry')
    def test_get_model_info_returns_dict(self, mock_registry_class, mock_torch_module, sample_metadata):
...
class TestConvenienceFunctions:
    ...
    def test_create_model_uses_factory(self, mock_get_factory, mock_torch_module):
        ...
        model = create_model(
            name="TestModel",
            hyperparameters={"in_channels": 16},
            task_type="graph_regression"
        )
...
class TestEdgeCasesAndErrorHandling:
    ...
    def test_empty_hyperparameters_dict(self, model_validator):
        ...
        schema = {
            "param1": {"type": "integer", "required": False, "default": 10}
        }
        # Should not raise
    ...
    @patch('milia_pipeline.models.factory.model_factory.ModelRegistry')
    @patch('milia_pipeline.models.factory.model_factory.get_model_metadata')
    def test_sample_data_without_x_attribute(self, mock_get_metadata, mock_registry_class, mock_torch_module, sample_metadata):
    ...
    @patch('milia_pipeline.models.factory.model_factory.ModelRegistry')
    @patch('milia_pipeline.models.factory.model_factory.get_model_metadata')
    def test_classification_without_y_attribute(self, mock_get_metadata, mock_registry_class, mock_torch_module, sample_metadata):
...
class TestIntegration:
    ...
    @patch('milia_pipeline.models.factory.model_factory.ModelRegistry')
    @patch('milia_pipeline.models.factory.model_factory.get_model_metadata')
    def test_complete_model_creation_workflow(self, mock_get_metadata, mock_registry_class, mock_torch_module, sample_metadata):
    ...
    @patch('milia_pipeline.models.factory.model_factory.ModelRegistry')
    @patch('milia_pipeline.models.factory.model_factory.get_model_metadata')
    def test_workflow_with_all_parameters_explicit(self, mock_get_metadata, mock_registry_class, mock_torch_module, sample_metadata):
...
class TestModelFactoryCustomArchitecture:
    ...
    @patch('milia_pipeline.models.factory.model_factory.parse_custom_architecture')
    @patch('milia_pipeline.models.factory.model_factory.ModelRegistry')
    def test_custom_architecture_successful_creation(self, mock_registry_class, mock_parse, mock_torch_module):
    ...
    @patch('milia_pipeline.models.factory.model_factory.parse_custom_architecture')
    @patch('milia_pipeline.models.factory.model_factory.ModelRegistry')
    def test_custom_architecture_channel_inference(self, mock_registry_class, mock_parse, mock_torch_module):
...
class TestModelFactoryEnsembleModel:
    ...
    @patch('milia_pipeline.models.factory.model_factory.get_model_metadata')
    @patch('milia_pipeline.models.factory.model_factory.ModelRegistry')
    def test_ensemble_successful_creation(self, mock_registry_class, mock_get_metadata, mock_parse, mock_torch_module, sample_metadata):
        ...
        config = {
            "strategy": "voting",
            "models": [
                {"name": "TestModel", "hyperparameters": {"in_channels": 16, "hidden_channels": 64, "out_channels": 1}, "weight": 1.0},
                {"name": "TestModel", "hyperparameters": {"in_channels": 16, "hidden_channels": 32, "out_channels": 1}, "weight": 1.0}
            ]
        }
...
class TestAdditionalValidatorScenarios:
    ...
    def test_very_large_parameter_values(self, model_validator):
        ...
        schema = {
            "param": {"type": "integer", "required": True, "max": 1000000}
        }
    ...
    def test_very_small_float_values(self, model_validator):
        ...
        schema = {
            "param": {"type": "float", "required": True, "min": 0.0}
        }
        hparams = {"param": 1e-10}
        model_validator.validate_hyperparameters(hparams, schema)
...
class TestErrorMessageQuality:
    ...
    def test_missing_required_error_message_clear(self, model_validator):
        ...
        schema = {
            "important_param": {"type": "integer", "required": True}
        }
        hparams = {}
    ...
    def test_range_error_message_shows_bounds(self, model_validator):
        ...
        schema = {
            "param": {"type": "integer", "required": True, "min": 1, "max": 10}
        }
        hparams = {"param": 15}
...
class TestRegressionScenarios:
    ...
    def test_validator_does_not_modify_schema(self, model_validator):
        ...
        schema = {
            "param": {"type": "integer", "required": True, "min": 1}
        }
...
class TestCreateModelWithInfo:
    ...
    @patch('milia_pipeline.models.factory.model_factory.get_model_metadata')
    @patch('milia_pipeline.models.factory.model_factory.ModelRegistry')
    def test_create_model_with_info_returns_tuple(self, mock_registry_class, mock_get_metadata, mock_torch_module):
    ...
    @patch('milia_pipeline.models.factory.model_factory.ModelRegistry')
    def test_uses_edge_features_true_when_requires_edge_features(self, mock_registry_class, mock_torch_module):
    ...
    @patch('milia_pipeline.models.factory.model_factory.ModelRegistry')
    def test_uses_edge_features_true_when_edge_dim_configured(self, mock_registry_class, mock_torch_module):
    ...
    @patch('milia_pipeline.models.factory.model_factory.ModelRegistry')
    def test_uses_edge_features_true_when_in_edge_channels_configured(self, mock_registry_class, mock_torch_module):
    ...
    @patch('milia_pipeline.models.factory.model_factory.ModelRegistry')
    def test_uses_edge_features_false_when_no_edge_params(self, mock_registry_class, mock_torch_module):
...
class TestGraphLevelModelWrapperInit:
    ...
    def test_init_custom_pooling_method(self):
        ...
        mock_model = nn.Linear(10, 5)
        wrapper = GraphLevelModelWrapper(mock_model, task_type='graph_regression', pooling_method='max')
...
class TestEdgeLevelModelWrapperInit:
    ...
    def test_init_custom_decoder_method(self):
        ...
        mock_model = nn.Linear(10, 5)
        mock_model.out_channels = 5
        wrapper = EdgeLevelModelWrapper(mock_model, task_type='edge_regression', decoder_method='concat_mlp')
    ...
    def test_init_edge_out_channels(self):
        ...
        mock_model = nn.Linear(10, 5)
        mock_model.out_channels = 5
        wrapper = EdgeLevelModelWrapper(mock_model, task_type='edge_regression', edge_out_channels=10)
