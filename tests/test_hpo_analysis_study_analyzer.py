...
class MockStudy:
    ...
    def __init__(
        ...
        trials: Optional[List[MockFrozenTrial]] = None,
        best_params: Optional[Dict[str, Any]] = None,
        best_value: Optional[float] = None,
        directions: Optional[List[MockStudyDirection]] = None,
        best_trials: Optional[List[MockFrozenTrial]] = None,
    ):
        self.study_name = study_name
...
class MockHPOManager:
    ...
    def __init__(self, study: Optional[MockStudy] = None):
        self.study = study
...
class TestImportanceMethodEnum:
    ...
    @patch('milia_pipeline.models.hpo.analysis.study_analyzer.HPOConfigurationError', MockHPOConfigurationError)
    @patch('milia_pipeline.models.hpo.analysis.study_analyzer.StudyNotFoundError', MockStudyNotFoundError)
...
class TestAnalysisConfigInit:
    ...
    def test_default_values(self):
        ...
        from milia_pipeline.models.hpo.analysis.study_analyzer import AnalysisConfig, ImportanceMethod
...
class TestStudyAnalyzerInit:
    ...
    def test_init_with_custom_config(self, mock_study):
        ...
        from milia_pipeline.models.hpo.analysis.study_analyzer import StudyAnalyzer, AnalysisConfig, ImportanceMethod
    ...
    def test_init_creates_default_config(self, mock_study):
        ...
        from milia_pipeline.models.hpo.analysis.study_analyzer import StudyAnalyzer, AnalysisConfig
    ...
    def test_init_with_none_study_raises_error(self):
        ...
        from milia_pipeline.models.hpo.analysis.study_analyzer import StudyAnalyzer, HPOError
...
class TestStudyAnalyzerFromStorage:
    ...
    def test_from_storage_nonexistent_raises_error(self, mock_optuna):
        ...
        from milia_pipeline.models.hpo.analysis.study_analyzer import StudyAnalyzer, StudyNotFoundError
        
        mock_optuna.load_study = mock_load_study
        
        with pytest.raises((MockStudyNotFoundError, StudyNotFoundError)) as exc_info:
            StudyAnalyzer.from_storage(
...
class TestGetTrials:
    ...
    def test_get_trials_contains_expected_keys(self, mock_study):
        ...
        expected_keys = {'number', 'params', 'value', 'state', 'duration', 
                        'user_attrs', 'intermediate_values', 'datetime_start', 'datetime_complete'}
...
class TestGetParameterImportance:
    ...
    @patch('milia_pipeline.models.hpo.analysis.study_analyzer.OPTUNA_AVAILABLE', True)
    @patch('milia_pipeline.models.hpo.analysis.study_analyzer.get_param_importances', mock_get_param_importances)
    @patch('milia_pipeline.models.hpo.analysis.study_analyzer.FanovaImportanceEvaluator', MockFanovaImportanceEvaluator)
    @patch('milia_pipeline.models.hpo.analysis.study_analyzer.HPOError', MockHPOError)
    @patch('milia_pipeline.models.hpo.analysis.study_analyzer.HPOConfigurationError', MockHPOConfigurationError)
    @patch('milia_pipeline.models.hpo.analysis.study_analyzer.StudyNotFoundError', MockStudyNotFoundError)
    ...
    def test_get_parameter_importance_with_mdi_method(self, mock_study):
        ...
        from milia_pipeline.models.hpo.analysis.study_analyzer import StudyAnalyzer, ImportanceMethod
    ...
    @patch('milia_pipeline.models.hpo.analysis.study_analyzer.OPTUNA_AVAILABLE', True)
    @patch('milia_pipeline.models.hpo.analysis.study_analyzer.get_param_importances', mock_get_param_importances_failure)
    @patch('milia_pipeline.models.hpo.analysis.study_analyzer.FanovaImportanceEvaluator', MockFanovaImportanceEvaluator)
    @patch('milia_pipeline.models.hpo.analysis.study_analyzer.HPOError', MockHPOError)
    @patch('milia_pipeline.models.hpo.analysis.study_analyzer.HPOConfigurationError', MockHPOConfigurationError)
    @patch('milia_pipeline.models.hpo.analysis.study_analyzer.StudyNotFoundError', MockStudyNotFoundError)
...
class TestGetConvergenceData:
    ...
    def test_get_convergence_data_contains_expected_keys(self, mock_study_for_convergence):
        ...
        expected_keys = {'trial_numbers', 'best_values', 'improvements', 
                        'convergence_rate', 'converged', 'convergence_trial'}
...
class TestGetOptimizationTrajectory:
    ...
    def test_get_optimization_trajectory_contains_expected_keys(self, mock_study_for_convergence):
        ...
        expected_keys = {'trials', 'duration_total', 'duration_mean', 
                        'values', 'best_value', 'best_trial'}
        assert set(data.keys()) == expected_keys
...
class TestGetSlicePlotData:
    ...
    def test_get_slice_plot_data_contains_expected_keys(self, mock_study):
        ...
        expected_keys = {'parameter_values', 'objective_values', 'best_value', 'best_param', 'parameter_name'}
        assert set(data.keys()) == expected_keys
...
class TestGetComprehensiveAnalysis:
    ...
    def test_get_comprehensive_analysis_contains_all_sections(self, mock_study):
        ...
        expected_keys = {'study_info', 'trial_counts', 'value_statistics', 
                        'convergence', 'trajectory', 'importance', 'correlations'}
...
class TestExportResults:
    ...
    def test_export_results_dict_format(self, mock_study):
        ...
        from milia_pipeline.models.hpo.analysis.study_analyzer import StudyAnalyzer, ExportFormat
...
class TestCompareWith:
    ...
    def test_compare_with_contains_expected_keys(self, mock_study, mock_study_maximize):
        ...
        expected_keys = {'studies', 'best_values', 'winner', 'trial_counts', 
                        'value_statistics', 'improvement'}
...
class TestIntegration:
    ...
    def test_full_analysis_workflow(self, mock_study):
        ...
        from milia_pipeline.models.hpo.analysis.study_analyzer import StudyAnalyzer, AnalysisConfig, ExportFormat
