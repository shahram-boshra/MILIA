...
from milia_pipeline.descriptors.descriptor_registry import (
    DescriptorRegistry, DescriptorRegistration, registry,
...
from milia_pipeline.descriptors.descriptor_categories import (
    DescriptorCategory, DescriptorMetadata
)
from milia_pipeline.exceptions import DescriptorValidationError, DescriptorError
...
class TestManualRegistration:
    ...
    def test_register_with_metadata(self, sample_function, sample_metadata):
        registry.register_descriptor("custom", sample_function, metadata=sample_metadata, plugin_name="p")
    ...
    def test_registration_to_dict_method(self, sample_function, sample_metadata):
        ...
        registry.register_descriptor("todict_test", sample_function, metadata=sample_metadata, plugin_name="testplugin")
...
class TestValidation:
    ...
    def test_override_builtin_with_plugin_error(self, sample_function):
        ...
        with pytest.raises(DescriptorValidationError) as exc_info:
            registry.register_descriptor("builtin_conflict_test", sample_function, is_builtin=False, plugin_name="p")
...
class TestCategoryFiltering:
    ...
    def test_electronic_category_filtering(self, sample_function):
        ...
        registry.register_descriptor("MaxPartialCharge_test", sample_function, metadata=meta, is_builtin=True)
...
class Test3DDescriptors:
    ...
    def test_get_charge_descriptors(self, sample_function):
        meta_charge = DescriptorMetadata("max", DescriptorCategory.ELECTRONIC, requires_charges=True)
        meta_no = DescriptorMetadata("mol", DescriptorCategory.CONSTITUTIONAL, requires_charges=False)
...
class TestStatistics:
    ...
    def test_statistics_by_category(self, sample_function):
        ...
        registry.register_descriptor("stat_const", sample_function, metadata=meta_const, is_builtin=True)
        registry.register_descriptor("stat_frag", sample_function, metadata=meta_frag, is_builtin=True)
    ...
    def test_statistics_requires_3d_count(self, sample_function):
        ...
        meta_2d = DescriptorMetadata("stat_2d", DescriptorCategory.CONSTITUTIONAL, requires_3d=False)
    ...
    def test_statistics_requires_charges_count(self, sample_function):
        ...
        meta_charge = DescriptorMetadata("stat_charge", DescriptorCategory.ELECTRONIC, requires_charges=True)
        
        registry.register_descriptor("stat_charge", sample_function, metadata=meta_charge, is_builtin=True)
    ...
    def test_statistics_unique_plugins_count(self, sample_function):
        ...
        registry.register_descriptor("p2", sample_function, plugin_name="plugin_alpha")  # Same plugin
...
class TestThreadSafety:
    ...
    def test_concurrent_category_filtering(self, sample_function):
        ...
        for i in range(5):
            ...
            registry.register_descriptor(f"thread_frag_{i}", sample_function, metadata=meta, is_builtin=True)
...
class TestEdgeCases:
    ...
    def test_metadata_equality_by_name(self, sample_function):
        ...
        meta2 = DescriptorMetadata("same_name", DescriptorCategory.TOPOLOGICAL)  # Different category
...
class TestAvailabilityReport:
    ...
    def test_availability_report_consistency(self, sample_function):
        ...
        registry.register_descriptor("consist_test", sample_function, metadata=meta, is_builtin=True)
...
class TestDescriptorRegistrationModel:
    ...
    def test_model_field_access(self, sample_function, sample_metadata):
        ...
        registry.register_descriptor("model_test", sample_function, metadata=sample_metadata, plugin_name="test_plugin")
    ...
    def test_model_to_dict_excludes_function_safely(self, sample_function, sample_metadata):
        ...
        registry.register_descriptor("dict_test", sample_function, metadata=sample_metadata, plugin_name="p")
