...
class TestDescriptorFiltering:
    ...
    def test_filtering_empty_list(self):
        ...
        valid, filtered = filter_descriptors_by_requirements([], has_3d=False, has_charges=False)
...
class TestEdgeCases:
    ...
    def test_filter_preserves_order(self):
        ...
        valid, _ = filter_descriptors_by_requirements(
            ordered_descriptors, has_3d=True, has_charges=True
        )
...
class TestDataIntegrity:
    ...
    def test_descriptors_by_category_matches_individual_lists(self):
        ...
        assert (
            DESCRIPTORS_BY_CATEGORY[DescriptorCategory.CONSTITUTIONAL] == CONSTITUTIONAL_DESCRIPTORS
        )
        ...
        assert (
            DESCRIPTORS_BY_CATEGORY[DescriptorCategory.DRUG_LIKENESS] == DRUG_LIKENESS_DESCRIPTORS
        )
...
class TestGeometricDescriptors:
    ...
    def test_all_geometric_require_3d(self):
        ...
        for desc in GEOMETRIC_DESCRIPTORS:
            assert desc.requires_3d is True, f"Geometric descriptor {desc.name} should require 3D"
