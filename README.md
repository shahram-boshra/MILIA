...
milia --list-descriptors             # 2,906+ descriptors: 418 built-in + 1,019 via addcore_3d + 20 via constitutional_property + 107 via topological_connectivity + 86 via walk_path_information + 177 via matrix_spectral + 606 via autocorrelation_2d + 316 via estate_atomtype + 150 via cats2d
