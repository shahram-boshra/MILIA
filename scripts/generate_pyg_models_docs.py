...
MODEL_CATALOG: dict[ModelCategory, list[tuple[str, str, str]]] = {
    ModelCategory.BASIC_GNN: [
        ...
        (
            "GAT",
            "torch_geometric.nn.models.GAT",
            "Graph Attention Network - Attention-based message passing",
        ),
        (
            "GIN",
            "torch_geometric.nn.models.GIN",
            "Graph Isomorphism Network - How powerful are GNNs?",
        ),
        (
            "EdgeCNN",
            "torch_geometric.nn.models.EdgeCNN",
            "Edge Convolutional Neural Network for point clouds",
        ),
    ...
    ModelCategory.CONVOLUTIONAL: [
        ...
        (
            ...
            "Graph convolution with separate self-loop weight",
        ),
        (
            "GatedGraphConv",
            "torch_geometric.nn.conv.GatedGraphConv",
            "Gated graph convolution from Li et al.",
        ),
        (
            "ResGatedGraphConv",
        ...
        (
            ...
            "Topology adaptive graph convolutional layer",
        ),
        ...
        (
            ...
            "Fast relational graph convolution",
        ),
        ...
        (
            ...
            "PointNet layer for point cloud processing",
        ),
        ...
        (
            ...
            "Dynamic edge convolution with kNN",
        ),
        ...
        (
            ...
            "Graph convolution with initial residual and identity mapping",
        ),
        ...
        (
            ...
            "General graph convolution framework",
        ),
        (
            "HGTConv",
        ...
        (
            ...
            "Heterogeneous edge-enhanced graph attention",
        ),
        (
            "HeteroConv",
            "torch_geometric.nn.conv.HeteroConv",
            "Heterogeneous graph convolution wrapper",
        ),
        ...
        (
            ...
            "Point GNN for 3D object detection",
        ),
        (
            "GPSConv",
        ...
        (
            ...
            "Anti-symmetric graph convolution",
        ),
    ...
    ModelCategory.POOLING: [
        (
            ...
            "Top-k pooling based on node scores",
        ),
        ...
        (
            "Set2Set",
            "torch_geometric.nn.pool.Set2Set",
            "Set2Set pooling for permutation invariance",
        ),
    ],
    ModelCategory.AGGREGATION: [
        (
            ...
            "Mean aggregation of node features",
        ),
        (
            "MaxAggregation",
            "torch_geometric.nn.aggr.MaxAggregation",
            "Max aggregation of node features",
        ),
        (
            "SumAggregation",
            "torch_geometric.nn.aggr.SumAggregation",
            "Sum aggregation of node features",
        ),
        (
            "StdAggregation",
            "torch_geometric.nn.aggr.StdAggregation",
        ...
        (
            ...
            "Learnable softmax aggregation",
        ),
        (
            "PowerMeanAggregation",
            "torch_geometric.nn.aggr.PowerMeanAggregation",
            "Learnable power mean aggregation",
        ),
    ...
    ModelCategory.ENCODER: [
        (
            ...
            "Unsupervised node embedding via random walks",
        ),
        (
            "DeepGraphInfomax",
            "torch_geometric.nn.models.DeepGraphInfomax",
            "Deep graph infomax for unsupervised learning",
        ),
        (
            "InnerProductDecoder",
    ...
    ModelCategory.AUTOENCODER: [
        ...
        (
            ...
            "Variational graph autoencoder with KL divergence",
        ),
        ("ARGA", "torch_geometric.nn.models.ARGA", "Adversarial regularized graph autoencoder"),
        (
            "ARGVA",
            "torch_geometric.nn.models.ARGVA",
            "Adversarial regularized variational autoencoder",
        ),
    ],
    ModelCategory.TRANSFORMER: [
        (
            "TransformerConv",
            "torch_geometric.nn.conv.TransformerConv",
            "Transformer-style attention for graphs",
        ),
        (
            "GPSConv",
            "torch_geometric.nn.conv.GPSConv",
    ...
    ModelCategory.META_LEARNING: [
        (
            ...
            "Meta-learning layer for graph networks",
        ),
        (
            "MetaPath2Vec",
            "torch_geometric.nn.models.MetaPath2Vec",
            "Meta-path based node embedding for heterogeneous graphs",
        ),
    ],
    ModelCategory.EXPLAINABILITY: [
        (
            ...
            "Explain GNN predictions via subgraph and feature masks",
        ),
        (
            "PGExplainer",
            "torch_geometric.nn.models.PGExplainer",
            "Parameterized explainer for GNNs",
        ),
        (
            "Attentive FP",
            "torch_geometric.nn.models.AttentiveFP",
            "Attention-based explainable molecular fingerprints",
        ),
    ],
    ModelCategory.UTILITY: [
        ...
        (
            ...
            "Jumping knowledge for adaptive receptive fields",
        ),
        (
            "LabelPropagation",
        ...
        (
            ...
            "Post-processing for node classification",
        ),
        ...
        (
            ...
            "Improved DimeNet with optimizations",
        ),
        (
            "RECT",
            "torch_geometric.nn.models.RECT",
...
def generate_category_sections(
    model_catalog: dict[ModelCategory, list[tuple[str, str, str]]], verbose: bool = False
) -> list[str]:
    """
