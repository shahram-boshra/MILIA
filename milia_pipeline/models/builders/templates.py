...
class ArchitectureTemplates:
    ...
    def attention_network(
        ...
        builder = ArchitectureBuilder(
            task_type, in_channels, out_channels, name="AttentionNetwork"
        )
    ...
    def deep_residual(
        ...
        """
        builder = ArchitectureBuilder(
            task_type, in_channels, out_channels, name="DeepResidual"
        )
    ...
    def hierarchical_pooling(
        ...
        logger.debug(f"Created hierarchical_pooling template: {num_levels} levels, ratio={pooling_ratio}")
        return builder
    ...
    def graph_sage_network(
        ...
        """
        builder = ArchitectureBuilder(
            task_type, in_channels, out_channels, name="GraphSAGENetwork"
        )
    ...
    def gin_network(
        ...
        """
        builder = ArchitectureBuilder(
            task_type, in_channels, out_channels, name="GINNetwork"
        )
    ...
    def molecular_network(
        ...
        """
        builder = ArchitectureBuilder(
            task_type, in_channels, out_channels, name="MolecularNetwork"
        )
        ...
        logger.debug(f"Created molecular_network template: {num_layers} layers, hidden={hidden_channels}")
        return builder
    ...
    def node_classification_network(
        ...
        logger.debug(f"Created node_classification_network: {num_layers} layers, classes={num_classes}")
        return builder
    ...
    def graph_classification_network(
        ...
        logger.debug(f"Created graph_classification_network: {num_layers} layers, classes={num_classes}")
        return builder
        ...
        info_map = {
            "simple_gcn": {
                ...
                "parameters": [
                    ...
                    "hidden_channels", "dropout", "task_type"
                ],
                "suitable_for": [
                    "graph_regression", "graph_classification",
                    "node_regression", "node_classification"
                ...
                "best_use_cases": [
                    "Quick prototyping", "Baseline models",
                    "Small to medium graphs", "When interpretability matters"
                ]
            },
            "attention_network": {
                ...
                "parameters": [
                    "in_channels", "out_channels", "num_layers",
                    "hidden_channels", "heads", "dropout", "task_type"
                ],
                "suitable_for": [
                    "graph_regression", "graph_classification",
                    "node_classification", "molecular_prediction"
                ],
                "best_use_cases": [
                    "Heterogeneous graphs", "Molecular property prediction",
                    "Social networks", "When node importance varies"
                ]
            },
            "deep_residual": {
                "name": "deep_residual",
                ...
                "best_use_cases": [
                    "Very deep networks (10+ layers)", "Complex graph structures",
                    "Training stability crucial", "Large-scale graphs"
                ]
            },
            "hybrid_conv_attention": {
                ...
                "parameters": [
                    "in_channels", "out_channels", "conv_layers",
                    "attention_layers", "hidden_channels", "heads", "dropout", "task_type"
                ],
                "suitable_for": [
                    "graph_regression", "graph_classification",
                    "node_classification"
                ...
                "best_use_cases": [
                    "Multi-scale learning", "Heterogeneous graphs",
                    "Combining local and global features"
                ]
            },
            "hierarchical_pooling": {
                ...
                "parameters": [
                    ...
                    "hidden_channels", "pooling_ratio", "task_type"
                ],
                "suitable_for": ["graph_regression", "graph_classification"],
                "best_use_cases": [
                    "Multi-scale analysis", "Large graphs requiring compression",
                    "Hierarchical structures", "Coarse-to-fine learning"
                ]
            },
            "graph_sage_network": {
                ...
                "parameters": [
                    "in_channels", "out_channels", "num_layers",
                    "hidden_channels", "aggr", "dropout", "task_type"
                ],
                "suitable_for": [
                    "graph_regression", "graph_classification",
                    "node_regression", "node_classification"
                ...
                "best_use_cases": [
                    "Large-scale graphs", "Inductive learning",
                    "Mini-batch training", "Dynamic graphs"
                ]
            },
            "gin_network": {
                "name": "gin_network",
                ...
                "parameters": [
                    "in_channels", "out_channels", "num_layers",
                    "hidden_channels", "dropout", "train_eps", "task_type"
                ],
                "suitable_for": [
                    "graph_regression", "graph_classification",
                ...
                "best_use_cases": [
                    "Graph isomorphism testing", "Molecular property prediction",
            ...
            "molecular_network": {
                ...
                "best_use_cases": [
                    "Drug discovery", "Chemical reaction prediction",
                    "Protein-ligand binding", "Molecular properties"
                ]
            },
            "node_classification_network": {
                ...
                "parameters": [
                    "in_channels", "num_classes", "hidden_channels",
                    "num_layers", "dropout"
                ],
            ...
            "graph_classification_network": {
                ...
                "best_use_cases": [
                    "Protein function prediction", "Molecule classification",
                    "Social network analysis", "Chemical compound categorization"
                ]
            }
        }
...
logger.info(f"templates module loaded - {len(ArchitectureTemplates.list_templates())} templates available")
