...
def print_module_summary():
    ...
    if info['builders_available']:
        print(f"    - Custom Architectures: ✓")
        print(f"    - Ensemble Models: ✓")
        print(f"    - Architecture Templates: ✓")
        print(f"    - Layer Registry: ✓")
    ...
    if info['hpo_available']:
        ...
        print(f"    - Optuna Backend: ✓")
        print(f"    - Pruning Callbacks: ✓")
        print(f"    - Search Space Builder: ✓")
        print(f"    - Study Analyzer: ✓")
