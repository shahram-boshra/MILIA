...
class DescriptorCalculator:
    ...
    def __init__(self,
                 ...
                 validator: Optional[DescriptorValidator] = None,
        ...
        logger.info(f"DescriptorCalculator initialized (cache={enable_cache}, "
                   f"fallback={fallback_on_error}, conformers={generate_conformers})")
    
    def calculate_single(self,
                        mol: Chem.Mol,
                        descriptor_name: str,
                        mol_identifier: str = "unknown") -> CalculationResult:
        """
        ...
        try:
            ...
            # Validate result
            is_valid_value, validation_msg = self.validator.validate_value(
    ...
    def calculate_batch(self,
                       ...
                       mol_identifier: str = "unknown") -> BatchCalculationResult:
        """
    ...
    def calculate_for_molecules(self,
                               molecules: List[Tuple[Chem.Mol, str]],
                               descriptor_names: List[str]) -> List[BatchCalculationResult]:
        """
