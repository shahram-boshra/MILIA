...
CONSTITUTIONAL_DESCRIPTORS: List[DescriptorMetadata] = [
    ...
    DescriptorMetadata("HeavyAtomMolWt", DescriptorCategory.CONSTITUTIONAL, description="Heavy atom molecular weight"),
    DescriptorMetadata("ExactMolWt", DescriptorCategory.CONSTITUTIONAL, description="Exact molecular weight"),
    
    # Atom counts (Note: These use Mol methods, not Descriptors module)
    DescriptorMetadata("NumHeavyAtoms", DescriptorCategory.CONSTITUTIONAL, 
                      description="Number of heavy atoms", rdkit_module="Mol"),
    DescriptorMetadata("NumAtoms", DescriptorCategory.CONSTITUTIONAL, 
                      description="Total number of atoms", rdkit_module="Mol"),
    DescriptorMetadata("NumHeteroatoms", DescriptorCategory.CONSTITUTIONAL, description="Number of heteroatoms"),
    DescriptorMetadata("NumValenceElectrons", DescriptorCategory.CONSTITUTIONAL, description="Number of valence electrons"),
    DescriptorMetadata("NumRadicalElectrons", DescriptorCategory.CONSTITUTIONAL, description="Number of radical electrons"),
    
    # Hydrogen counts
    DescriptorMetadata("NumHAcceptors", DescriptorCategory.CONSTITUTIONAL, description="Number of H-bond acceptors"),
    DescriptorMetadata("NumHDonors", DescriptorCategory.CONSTITUTIONAL, description="Number of H-bond donors"),
    
    # Bond counts
    DescriptorMetadata("NumRotatableBonds", DescriptorCategory.CONSTITUTIONAL, description="Number of rotatable bonds"),
    DescriptorMetadata("NumAmideBonds", DescriptorCategory.CONSTITUTIONAL, description="Number of amide bonds"),
    DescriptorMetadata("NumBridgeheadAtoms", DescriptorCategory.CONSTITUTIONAL, description="Number of bridgehead atoms"),
    DescriptorMetadata("NumSpiroAtoms", DescriptorCategory.CONSTITUTIONAL, description="Number of spiro atoms"),
    
    # Ring descriptors
    DescriptorMetadata("NumAromaticRings", DescriptorCategory.CONSTITUTIONAL, description="Number of aromatic rings"),
    DescriptorMetadata("NumSaturatedRings", DescriptorCategory.CONSTITUTIONAL, description="Number of saturated rings"),
    DescriptorMetadata("NumAliphaticRings", DescriptorCategory.CONSTITUTIONAL, description="Number of aliphatic rings"),
    DescriptorMetadata("NumAromaticHeterocycles", DescriptorCategory.CONSTITUTIONAL, description="Number of aromatic heterocycles"),
    DescriptorMetadata("NumAromaticCarbocycles", DescriptorCategory.CONSTITUTIONAL, description="Number of aromatic carbocycles"),
    DescriptorMetadata("NumSaturatedHeterocycles", DescriptorCategory.CONSTITUTIONAL, description="Number of saturated heterocycles"),
    DescriptorMetadata("NumSaturatedCarbocycles", DescriptorCategory.CONSTITUTIONAL, description="Number of saturated carbocycles"),
    DescriptorMetadata("NumAliphaticHeterocycles", DescriptorCategory.CONSTITUTIONAL, description="Number of aliphatic heterocycles"),
    DescriptorMetadata("NumAliphaticCarbocycles", DescriptorCategory.CONSTITUTIONAL, description="Number of aliphatic carbocycles"),
    
    # Ring size descriptors
    DescriptorMetadata("RingCount", DescriptorCategory.CONSTITUTIONAL, description="Total number of rings"),
    
    # Fraction descriptors (Note: RDKit uses uppercase CSP3)
    DescriptorMetadata("FractionCSP3", DescriptorCategory.CONSTITUTIONAL, description="Fraction of sp3 carbons"),
    
    # Lipinski descriptors
    DescriptorMetadata("MolLogP", DescriptorCategory.CONSTITUTIONAL, description="Wildman-Crippen LogP"),
    DescriptorMetadata("MolMR", DescriptorCategory.CONSTITUTIONAL, description="Molecular refractivity"),
    
    # TPSA
    DescriptorMetadata("TPSA", DescriptorCategory.CONSTITUTIONAL, description="Topological polar surface area"),
    DescriptorMetadata("LabuteASA", DescriptorCategory.CONSTITUTIONAL, description="Labute's approximate surface area"),
    
    # Additional descriptors
    DescriptorMetadata("NumUnspecifiedAtomStereoCenters", DescriptorCategory.CONSTITUTIONAL, 
                      description="Number of unspecified atom stereocenters"),
    DescriptorMetadata("NumDefinedAtomStereoCenters", DescriptorCategory.CONSTITUTIONAL,
                      description="Number of defined atom stereocenters"),
    DescriptorMetadata("NumUnassignedAtomStereoCenters", DescriptorCategory.CONSTITUTIONAL,
                      description="Number of unassigned atom stereocenters"),
    DescriptorMetadata("NumUnspecifiedBondStereoCenters", DescriptorCategory.CONSTITUTIONAL,
                      description="Number of unspecified bond stereocenters"),
    DescriptorMetadata("NumDefinedBondStereoCenters", DescriptorCategory.CONSTITUTIONAL,
                      description="Number of defined bond stereocenters"),
    DescriptorMetadata("NumUnassignedBondStereoCenters", DescriptorCategory.CONSTITUTIONAL,
...
TOPOLOGICAL_CORE: List[DescriptorMetadata] = [
    ...
    DescriptorMetadata("HallKierAlpha", DescriptorCategory.TOPOLOGICAL, description="Hall-Kier alpha"),
    ...
    DescriptorMetadata("Chi0v", DescriptorCategory.TOPOLOGICAL, description="Chi0v connectivity index"),
    DescriptorMetadata("Chi1v", DescriptorCategory.TOPOLOGICAL, description="Chi1v connectivity index"),
    DescriptorMetadata("Chi2v", DescriptorCategory.TOPOLOGICAL, description="Chi2v connectivity index"),
    DescriptorMetadata("Chi3v", DescriptorCategory.TOPOLOGICAL, description="Chi3v connectivity index"),
    DescriptorMetadata("Chi4v", DescriptorCategory.TOPOLOGICAL, description="Chi4v connectivity index"),
    DescriptorMetadata("Chi0n", DescriptorCategory.TOPOLOGICAL, description="Chi0n connectivity index"),
    DescriptorMetadata("Chi1n", DescriptorCategory.TOPOLOGICAL, description="Chi1n connectivity index"),
    DescriptorMetadata("Chi2n", DescriptorCategory.TOPOLOGICAL, description="Chi2n connectivity index"),
    DescriptorMetadata("Chi3n", DescriptorCategory.TOPOLOGICAL, description="Chi3n connectivity index"),
    DescriptorMetadata("Chi4n", DescriptorCategory.TOPOLOGICAL, description="Chi4n connectivity index"),
    DescriptorMetadata("Ipc", DescriptorCategory.TOPOLOGICAL, description="Information content (mean)"),
    DescriptorMetadata("AvgIpc", DescriptorCategory.TOPOLOGICAL, description="Average information content"),
    DescriptorMetadata("BalabanJ", DescriptorCategory.TOPOLOGICAL, description="Balaban J index"),
    DescriptorMetadata("FpDensityMorgan1", DescriptorCategory.TOPOLOGICAL, description="Morgan fingerprint density 1"),
    DescriptorMetadata("FpDensityMorgan2", DescriptorCategory.TOPOLOGICAL, description="Morgan fingerprint density 2"),
    DescriptorMetadata("FpDensityMorgan3", DescriptorCategory.TOPOLOGICAL, description="Morgan fingerprint density 3"),
    DescriptorMetadata("HeavyAtomCount", DescriptorCategory.TOPOLOGICAL, description="Heavy atom count"),
...
TOPOLOGICAL_PEOE_VSA: List[DescriptorMetadata] = [
    DescriptorMetadata(f"PEOE_VSA{i}", DescriptorCategory.TOPOLOGICAL, 
                      description=f"PEOE VSA descriptor {i}")
...
TOPOLOGICAL_SMR_VSA: List[DescriptorMetadata] = [
    DescriptorMetadata(f"SMR_VSA{i}", DescriptorCategory.TOPOLOGICAL,
                      description=f"SMR VSA descriptor {i}")
...
TOPOLOGICAL_SLOGP_VSA: List[DescriptorMetadata] = [
    DescriptorMetadata(f"SlogP_VSA{i}", DescriptorCategory.TOPOLOGICAL,
                      description=f"SlogP VSA descriptor {i}")
...
TOPOLOGICAL_ESTATE_VSA: List[DescriptorMetadata] = [
    DescriptorMetadata(f"EState_VSA{i}", DescriptorCategory.TOPOLOGICAL,
                      description=f"EState VSA descriptor {i}")
...
TOPOLOGICAL_VSA_ESTATE: List[DescriptorMetadata] = [
    DescriptorMetadata(f"VSA_EState{i}", DescriptorCategory.TOPOLOGICAL,
                      description=f"VSA EState descriptor {i}")
...
TOPOLOGICAL_BCUT2D: List[DescriptorMetadata] = [
    DescriptorMetadata("BCUT2D_MWHI", DescriptorCategory.TOPOLOGICAL, description="BCUT2D molecular weight high"),
    DescriptorMetadata("BCUT2D_MWLOW", DescriptorCategory.TOPOLOGICAL, description="BCUT2D molecular weight low"),
    DescriptorMetadata("BCUT2D_CHGHI", DescriptorCategory.TOPOLOGICAL, description="BCUT2D charge high"),
    DescriptorMetadata("BCUT2D_CHGLO", DescriptorCategory.TOPOLOGICAL, description="BCUT2D charge low"),
    DescriptorMetadata("BCUT2D_LOGPHI", DescriptorCategory.TOPOLOGICAL, description="BCUT2D LogP high"),
    DescriptorMetadata("BCUT2D_LOGPLOW", DescriptorCategory.TOPOLOGICAL, description="BCUT2D LogP low"),
...
TOPOLOGICAL_AUTOCORR2D: List[DescriptorMetadata] = [
    DescriptorMetadata(f"AUTOCORR2D_{i}", DescriptorCategory.TOPOLOGICAL,
...
ELECTRONIC_DESCRIPTORS: List[DescriptorMetadata] = [
    DescriptorMetadata("MaxPartialCharge", DescriptorCategory.ELECTRONIC, 
                      requires_charges=True, description="Maximum partial charge"),
    DescriptorMetadata("MinPartialCharge", DescriptorCategory.ELECTRONIC,
                      requires_charges=True, description="Minimum partial charge"),
    DescriptorMetadata("MaxAbsPartialCharge", DescriptorCategory.ELECTRONIC,
                      requires_charges=True, description="Maximum absolute partial charge"),
    DescriptorMetadata("MinAbsPartialCharge", DescriptorCategory.ELECTRONIC,
                      requires_charges=True, description="Minimum absolute partial charge"),
    DescriptorMetadata("MaxEStateIndex", DescriptorCategory.ELECTRONIC,
                      description="Maximum E-state index"),
    DescriptorMetadata("MinEStateIndex", DescriptorCategory.ELECTRONIC,
                      description="Minimum E-state index"),
    DescriptorMetadata("MaxAbsEStateIndex", DescriptorCategory.ELECTRONIC,
                      description="Maximum absolute E-state index"),
    DescriptorMetadata("MinAbsEStateIndex", DescriptorCategory.ELECTRONIC,
...
GEOMETRIC_DESCRIPTORS: List[DescriptorMetadata] = [
    DescriptorMetadata("RadiusOfGyration", DescriptorCategory.GEOMETRIC,
                      requires_3d=True, rdkit_module="Descriptors3D",
                      description="Radius of gyration"),
    DescriptorMetadata("InertialShapeFactor", DescriptorCategory.GEOMETRIC,
                      requires_3d=True, rdkit_module="Descriptors3D",
                      description="Inertial shape factor"),
    DescriptorMetadata("Eccentricity", DescriptorCategory.GEOMETRIC,
                      requires_3d=True, rdkit_module="Descriptors3D",
                      description="Molecular eccentricity"),
    DescriptorMetadata("Asphericity", DescriptorCategory.GEOMETRIC,
                      requires_3d=True, rdkit_module="Descriptors3D",
                      description="Molecular asphericity"),
    DescriptorMetadata("SpherocityIndex", DescriptorCategory.GEOMETRIC,
                      requires_3d=True, rdkit_module="Descriptors3D",
                      description="Spherocity index"),
    DescriptorMetadata("PBF", DescriptorCategory.GEOMETRIC,
                      requires_3d=True, rdkit_module="Descriptors3D",
                      description="Plane of best fit"),
    DescriptorMetadata("NPR1", DescriptorCategory.GEOMETRIC,
                      requires_3d=True, rdkit_module="Descriptors3D",
                      description="Normalized principal moments ratio 1"),
    DescriptorMetadata("NPR2", DescriptorCategory.GEOMETRIC,
                      requires_3d=True, rdkit_module="Descriptors3D",
                      description="Normalized principal moments ratio 2"),
    DescriptorMetadata("PMI1", DescriptorCategory.GEOMETRIC,
                      requires_3d=True, rdkit_module="Descriptors3D",
                      description="Principal moment of inertia 1"),
    DescriptorMetadata("PMI2", DescriptorCategory.GEOMETRIC,
                      requires_3d=True, rdkit_module="Descriptors3D",
                      description="Principal moment of inertia 2"),
    DescriptorMetadata("PMI3", DescriptorCategory.GEOMETRIC,
                      requires_3d=True, rdkit_module="Descriptors3D",
...
DRUG_LIKENESS_DESCRIPTORS: List[DescriptorMetadata] = [
    DescriptorMetadata("qed", DescriptorCategory.DRUG_LIKENESS,
                      description="Quantitative estimate of drug-likeness"),
    DescriptorMetadata("SPS", DescriptorCategory.DRUG_LIKENESS,
                      description="Synthetic accessibility score"),
    DescriptorMetadata("Phi", DescriptorCategory.DRUG_LIKENESS,
                      description="Kier flexibility index"),
    DescriptorMetadata("FractionCSP3", DescriptorCategory.DRUG_LIKENESS,
...
FRAGMENT_DESCRIPTORS: List[DescriptorMetadata] = [
    DescriptorMetadata(name, DescriptorCategory.FRAGMENTS,
                      description=f"Fragment descriptor: {name}")
...
def get_descriptor_metadata(name: str) -> Optional[DescriptorMetadata]:
    """
...
def validate_descriptor_coverage() -> Dict[str, Any]:
    ...
    return {
        ...
        "coverage_complete": all(
            actual_counts[cat] >= expected_counts[cat]
...
logger.info(f"Loaded {len(ALL_DESCRIPTORS)} RDKit descriptors across {len(DESCRIPTORS_BY_CATEGORY)} categories")
