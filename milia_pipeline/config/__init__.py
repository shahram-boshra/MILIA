...
from .config_accessors import (
    ...
    # Phase 5: Dataset Type Validation (NEW)
    get_valid_dataset_types,
    is_valid_dataset_type,
    
    # Phase 5: Handler & Feature Queries (NEW)
    is_handler_type,
...
try:
    from .config_constants import _REGISTRY_AVAILABLE, _CACHE_INVALIDATION_REGISTERED
...
try:
    from .config_containers import (
        _REGISTRY_AVAILABLE as _CONTAINERS_REGISTRY_AVAILABLE,
        verify_container_registry_integration
    )
...
try:
    from .config_accessors import (
        _REGISTRY_AVAILABLE as _ACCESSORS_REGISTRY_AVAILABLE,
        _REGISTRY_INITIALIZED as _ACCESSORS_REGISTRY_INITIALIZED
    )
...
try:
    from .config_loader import (
        _REGISTRY_AVAILABLE as _LOADER_REGISTRY_AVAILABLE_CHECK,
        _REGISTRY_INITIALIZED as _LOADER_REGISTRY_INITIALIZED_CHECK
    )
...
try:
    from .data_refining import (
        _REGISTRY_AVAILABLE as _REFINING_REGISTRY_AVAILABLE_CHECK,
        _REGISTRY_INITIALIZED as _REFINING_REGISTRY_INITIALIZED_CHECK
    )
...
try:
    from .validators import (
        _REGISTRY_AVAILABLE as _VALIDATORS_REGISTRY_AVAILABLE_CHECK,
        _REGISTRY_INITIALIZED as _VALIDATORS_REGISTRY_INITIALIZED_CHECK
    )
