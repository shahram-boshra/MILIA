...
_registration_error: Optional[Exception] = None
...
def _register_with_plugin_system() -> bool:
    ...
    try:
        ...
        from milia_pipeline.transformations.plugin_system import PluginRegistry, PluginMetadata
...
def get_transform(name: str) -> Optional[Type]:
    """
